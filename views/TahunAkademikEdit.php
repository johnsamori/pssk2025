...
<?php if ($Page->id_tahun->Visible) { // id_tahun ?>
    <div id="r_id_tahun"<?= $Page->id_tahun->rowAttributes() ?>>
        <label id="elh_tahun_akademik_id_tahun" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_tahun->caption() ?><?= $Page->id_tahun->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id_tahun->getDisplayValue($Page->id_tahun->getEditValue()))) ?>"></span>
<input type="hidden" data-table="tahun_akademik" data-field="x_id_tahun" data-hidden="1" name="x_id_tahun" id="x_id_tahun" value="<?= HtmlEncode($Page->id_tahun->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
