...
<form name="fsemester_antaraadd" id="fsemester_antaraadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script<?= Nonce() ?>>
loadjs.ready(["fsemester_antaraadd", "datetimepicker"], function () {
...
<?php } ?>
<script<?= Nonce() ?>>
loadjs.ready(['fsemester_antaraadd', 'jqueryinputmask'], function() {
	options = {
		'jitMasking': false,
		'removeMaskOnSubmit': true
	};
	ew.createjQueryInputMask("fsemester_antaraadd", "x_Tanggal", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fsemester_antaraadd', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fsemester_antaraadd", "x_User_id", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
<?php
    if (in_array("detil_semester_antara", explode(",", $Page->getCurrentDetailTable())) && $detil_semester_antara->DetailAdd) {
?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fsemester_antaraadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fsemester_antaraadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
