...
<form name="fmahasiswaedit" id="fmahasiswaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script<?= Nonce() ?>>
...
<input type="hidden" data-table="mahasiswa" data-field="x_NIM" data-hidden="1" data-old name="o_NIM" id="o_NIM" value="<?= HtmlEncode($Page->NIM->OldValue ?? $Page->NIM->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script<?= Nonce() ?>>
loadjs.ready(["fmahasiswaedit", "datetimepicker"], function () {
...
<?php } ?>
<script<?= Nonce() ?>>
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	options = {
		'jitMasking': false,
		'removeMaskOnSubmit': true
	};
	ew.createjQueryInputMask("fmahasiswaedit", "x_Tanggal_Lahir", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Nilai_Raport_Kelas_10", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Nilai_Raport_Kelas_11", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Nilai_Raport_Kelas_12", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Tanggal_Daftar", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Tes_Potensi_Akademik", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Tes_Wawancara", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Tes_Kesehatan", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Test_MMPI", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
loadjs.ready(['fmahasiswaedit', 'jqueryinputmask'], function() {
	...
	ew.createjQueryInputMask("fmahasiswaedit", "x_Tarif_SPP", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fmahasiswaedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fmahasiswaedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
<script>
loadjs.ready("head", function() { $("#fmahasiswaedit:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()})});
</script>
<?php } ?>
<script<?= Nonce() ?>>
