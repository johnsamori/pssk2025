...
$Page->showMessage();
?>
<form name="fbeasiswadelete" id="fbeasiswadelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php if ($Page->id_beasiswa->Visible) { // id_beasiswa ?>
        <th class="<?= $Page->id_beasiswa->headerCellClass() ?>"><span id="elh_beasiswa_id_beasiswa" class="beasiswa_id_beasiswa"><?= $Page->id_beasiswa->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Nama_Beasiswa->Visible) { // Nama_Beasiswa ?>
        <th class="<?= $Page->Nama_Beasiswa->headerCellClass() ?>"><span id="elh_beasiswa_Nama_Beasiswa" class="beasiswa_Nama_Beasiswa"><?= $Page->Nama_Beasiswa->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<?php if ($Page->id_beasiswa->Visible) { // id_beasiswa ?>
        <td<?= $Page->id_beasiswa->cellAttributes() ?>>
<span id="">
...
<?php } ?>
<?php if ($Page->Nama_Beasiswa->Visible) { // Nama_Beasiswa ?>
        <td<?= $Page->Nama_Beasiswa->cellAttributes() ?>>
<span id="">
