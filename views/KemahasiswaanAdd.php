...
<form name="fkemahasiswaanadd" id="fkemahasiswaanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script<?= Nonce() ?>>
loadjs.ready(['fkemahasiswaanadd', 'jqueryinputmask'], function() {
	options = {
		'alias': 'numeric',
		'autoUnmask': true,
		'jitMasking': false,
	...
	ew.createjQueryInputMask("fkemahasiswaanadd", "x_id_kemahasiswaan", jQuery.extend(true, "", options));
});
</script>
</span>
</div></div>
...
<script<?= Nonce() ?>>
loadjs.ready("fkemahasiswaanadd", function() {
    fkemahasiswaanadd.createAutoSuggest(Object.assign({"id":"x_NIM","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->NIM->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.kemahasiswaan.fields.NIM.autoSuggestOptions));
});
</script>
...
<script<?= Nonce() ?>>
loadjs.ready("fkemahasiswaanadd", function() {
    fkemahasiswaanadd.createAutoSuggest(Object.assign({"id":"x_Jenis_Beasiswa","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->Jenis_Beasiswa->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.kemahasiswaan.fields.Jenis_Beasiswa.autoSuggestOptions));
});
</script>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fkemahasiswaanadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fkemahasiswaanadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
<script>
loadjs.ready("head", function() { $("#fkemahasiswaanadd:first *:input[type!=hidden]:first").focus(),$("input").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("select").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()}),$("radio").keydown(function(i){if(13==i.which){var e=$(this).closest("form").find(":input:visible:enabled"),n=e.index(this);n==e.length-1||(e.eq(e.index(this)+1).focus(),i.preventDefault())}else 113==i.which&&$("#btn-action").click()})});
</script>
<?php } ?>
<script<?= Nonce() ?>>
