...
class AuthenticationEventSubscriber implements EventSubscriberInterface
{
    ...
    public function onUserLogin(CheckPassportEvent $event): void
    {
        ...
        if ($request->request->get(Config('SECURITY.firewalls.main.remember_me.remember_me_parameter'))) {
            $request->getSession()->set(SESSION_USER_PROFILE_REMEMBER_ME, true); // Save remember me
        }
    }
