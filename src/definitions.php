...
return [
    ...
    "annex" => \DI\autowire(Annex::class),
    "beasiswa" => \DI\autowire(Beasiswa::class),
    "cuti_akademik" => \DI\autowire(CutiAkademik::class),
    "daftar_matakuliah" => \DI\autowire(DaftarMatakuliah::class),
    "daftar matakuliah" => \DI\get("daftar_matakuliah"),
    "detil_mata_kuliah" => \DI\autowire(DetilMataKuliah::class),
    "detil_semester_antara" => \DI\autowire(DetilSemesterAntara::class),
    "detil_ujian_tahap_bersama" => \DI\autowire(DetilUjianTahapBersama::class),
    "dosen" => \DI\autowire(Dosen::class),
    "karya_ilmiah" => \DI\autowire(KaryaIlmiah::class),
    "kemahasiswaan" => \DI\autowire(Kemahasiswaan::class),
    "kesehatan_mahasiswa" => \DI\autowire(KesehatanMahasiswa::class),
    "mahasiswa" => \DI\autowire(Mahasiswa::class),
    "mata_kuliah" => \DI\autowire(MataKuliah::class),
    "pembimbingan" => \DI\autowire(Pembimbingan::class),
    "penyakit" => \DI\autowire(Penyakit::class),
    "semester_antara" => \DI\autowire(SemesterAntara::class),
    "tahun_akademik" => \DI\autowire(TahunAkademik::class),
    "ujian_tahap_bersama" => \DI\autowire(UjianTahapBersama::class),
    "dashboard2" => \DI\autowire(Dashboard2::class),
