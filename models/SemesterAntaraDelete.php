 ...
 * Page class
 */
class SemesterAntaraDelete extends SemesterAntara
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "SemesterAntaraDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "semesterantaradelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("semesterantaralist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("semesterantaralist"); // Return to list
                return;
            }
        }
