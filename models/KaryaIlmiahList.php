 ...
 * Page class
 */
class KaryaIlmiahList extends KaryaIlmiah
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "KaryaIlmiahList";
    ...
    public string $FormName = "fkarya_ilmiahlist";

    // CSS class/style
    public string $CurrentPageName = "karyailmiahlist";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        // Initialize URLs
        $this->AddUrl = "karyailmiahadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "karyailmiahdelete";
        $this->MultiUpdateUrl = "karyailmiahupdate";
...
// Is modal
        ...
        if ($this->IsModal) {
            $this->FormName = "fkarya_ilmiahgrid";
        }
		...
		if (ReadCookie('karya_ilmiah_searchpanel') == 'notactive' || ReadCookie('karya_ilmiah_searchpanel') == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (ReadCookie('karya_ilmiah_searchpanel') == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fkarya_ilmiahsrch");
        }
        $filterList = Concat($filterList, $this->Id_karya_ilmiah->AdvancedSearch->toJson(), ","); // Field Id_karya_ilmiah
        $filterList = Concat($filterList, $this->NIM->AdvancedSearch->toJson(), ","); // Field NIM
        $filterList = Concat($filterList, $this->Judul_Penelitian->AdvancedSearch->toJson(), ","); // Field Judul_Penelitian
        $filterList = Concat($filterList, $this->Pembimbing_1->AdvancedSearch->toJson(), ","); // Field Pembimbing_1
        $filterList = Concat($filterList, $this->Pembimbing_2->AdvancedSearch->toJson(), ","); // Field Pembimbing_2
        $filterList = Concat($filterList, $this->Pembimbing_3->AdvancedSearch->toJson(), ","); // Field Pembimbing_3
        $filterList = Concat($filterList, $this->Penguji_1->AdvancedSearch->toJson(), ","); // Field Penguji_1
        $filterList = Concat($filterList, $this->Penguji_2->AdvancedSearch->toJson(), ","); // Field Penguji_2
        $filterList = Concat($filterList, $this->Lembar_Pengesahan->AdvancedSearch->toJson(), ","); // Field Lembar_Pengesahan
        $filterList = Concat($filterList, $this->Judul_Publikasi->AdvancedSearch->toJson(), ","); // Field Judul_Publikasi
        $filterList = Concat($filterList, $this->Link_Publikasi->AdvancedSearch->toJson(), ","); // Field Link_Publikasi
    ...
    protected function processFilterList(): bool
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fkarya_ilmiahsrch", $filters);
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field Id_karya_ilmiah
        $this->Id_karya_ilmiah->AdvancedSearch->SearchValue = $filter["x_Id_karya_ilmiah"] ?? "";
        $this->Id_karya_ilmiah->AdvancedSearch->SearchOperator = $filter["z_Id_karya_ilmiah"] ?? "";
        $this->Id_karya_ilmiah->AdvancedSearch->SearchCondition = $filter["v_Id_karya_ilmiah"] ?? "";
        $this->Id_karya_ilmiah->AdvancedSearch->SearchValue2 = $filter["y_Id_karya_ilmiah"] ?? "";
        $this->Id_karya_ilmiah->AdvancedSearch->SearchOperator2 = $filter["w_Id_karya_ilmiah"] ?? "";
        $this->Id_karya_ilmiah->AdvancedSearch->save();
        ...
        $this->Judul_Penelitian->AdvancedSearch->SearchValue = $filter["x_Judul_Penelitian"] ?? "";
        $this->Judul_Penelitian->AdvancedSearch->SearchOperator = $filter["z_Judul_Penelitian"] ?? "";
        $this->Judul_Penelitian->AdvancedSearch->SearchCondition = $filter["v_Judul_Penelitian"] ?? "";
        $this->Judul_Penelitian->AdvancedSearch->SearchValue2 = $filter["y_Judul_Penelitian"] ?? "";
        $this->Judul_Penelitian->AdvancedSearch->SearchOperator2 = $filter["w_Judul_Penelitian"] ?? "";
        $this->Judul_Penelitian->AdvancedSearch->save();

        // Field Pembimbing_1
        $this->Pembimbing_1->AdvancedSearch->SearchValue = $filter["x_Pembimbing_1"] ?? "";
        $this->Pembimbing_1->AdvancedSearch->SearchOperator = $filter["z_Pembimbing_1"] ?? "";
        $this->Pembimbing_1->AdvancedSearch->SearchCondition = $filter["v_Pembimbing_1"] ?? "";
        $this->Pembimbing_1->AdvancedSearch->SearchValue2 = $filter["y_Pembimbing_1"] ?? "";
        $this->Pembimbing_1->AdvancedSearch->SearchOperator2 = $filter["w_Pembimbing_1"] ?? "";
        $this->Pembimbing_1->AdvancedSearch->save();

        // Field Pembimbing_2
        $this->Pembimbing_2->AdvancedSearch->SearchValue = $filter["x_Pembimbing_2"] ?? "";
        $this->Pembimbing_2->AdvancedSearch->SearchOperator = $filter["z_Pembimbing_2"] ?? "";
        $this->Pembimbing_2->AdvancedSearch->SearchCondition = $filter["v_Pembimbing_2"] ?? "";
        $this->Pembimbing_2->AdvancedSearch->SearchValue2 = $filter["y_Pembimbing_2"] ?? "";
        $this->Pembimbing_2->AdvancedSearch->SearchOperator2 = $filter["w_Pembimbing_2"] ?? "";
        $this->Pembimbing_2->AdvancedSearch->save();

        // Field Pembimbing_3
        $this->Pembimbing_3->AdvancedSearch->SearchValue = $filter["x_Pembimbing_3"] ?? "";
        $this->Pembimbing_3->AdvancedSearch->SearchOperator = $filter["z_Pembimbing_3"] ?? "";
        $this->Pembimbing_3->AdvancedSearch->SearchCondition = $filter["v_Pembimbing_3"] ?? "";
        $this->Pembimbing_3->AdvancedSearch->SearchValue2 = $filter["y_Pembimbing_3"] ?? "";
        $this->Pembimbing_3->AdvancedSearch->SearchOperator2 = $filter["w_Pembimbing_3"] ?? "";
        $this->Pembimbing_3->AdvancedSearch->save();

        // Field Penguji_1
        $this->Penguji_1->AdvancedSearch->SearchValue = $filter["x_Penguji_1"] ?? "";
        $this->Penguji_1->AdvancedSearch->SearchOperator = $filter["z_Penguji_1"] ?? "";
        $this->Penguji_1->AdvancedSearch->SearchCondition = $filter["v_Penguji_1"] ?? "";
        $this->Penguji_1->AdvancedSearch->SearchValue2 = $filter["y_Penguji_1"] ?? "";
        $this->Penguji_1->AdvancedSearch->SearchOperator2 = $filter["w_Penguji_1"] ?? "";
        $this->Penguji_1->AdvancedSearch->save();

        // Field Penguji_2
        $this->Penguji_2->AdvancedSearch->SearchValue = $filter["x_Penguji_2"] ?? "";
        $this->Penguji_2->AdvancedSearch->SearchOperator = $filter["z_Penguji_2"] ?? "";
        $this->Penguji_2->AdvancedSearch->SearchCondition = $filter["v_Penguji_2"] ?? "";
        $this->Penguji_2->AdvancedSearch->SearchValue2 = $filter["y_Penguji_2"] ?? "";
        $this->Penguji_2->AdvancedSearch->SearchOperator2 = $filter["w_Penguji_2"] ?? "";
        $this->Penguji_2->AdvancedSearch->save();

        // Field Lembar_Pengesahan
        $this->Lembar_Pengesahan->AdvancedSearch->SearchValue = $filter["x_Lembar_Pengesahan"] ?? "";
        $this->Lembar_Pengesahan->AdvancedSearch->SearchOperator = $filter["z_Lembar_Pengesahan"] ?? "";
        $this->Lembar_Pengesahan->AdvancedSearch->SearchCondition = $filter["v_Lembar_Pengesahan"] ?? "";
        $this->Lembar_Pengesahan->AdvancedSearch->SearchValue2 = $filter["y_Lembar_Pengesahan"] ?? "";
        $this->Lembar_Pengesahan->AdvancedSearch->SearchOperator2 = $filter["w_Lembar_Pengesahan"] ?? "";
        $this->Lembar_Pengesahan->AdvancedSearch->save();

        // Field Judul_Publikasi
        $this->Judul_Publikasi->AdvancedSearch->SearchValue = $filter["x_Judul_Publikasi"] ?? "";
        $this->Judul_Publikasi->AdvancedSearch->SearchOperator = $filter["z_Judul_Publikasi"] ?? "";
        $this->Judul_Publikasi->AdvancedSearch->SearchCondition = $filter["v_Judul_Publikasi"] ?? "";
        $this->Judul_Publikasi->AdvancedSearch->SearchValue2 = $filter["y_Judul_Publikasi"] ?? "";
        $this->Judul_Publikasi->AdvancedSearch->SearchOperator2 = $filter["w_Judul_Publikasi"] ?? "";
        $this->Judul_Publikasi->AdvancedSearch->save();

        // Field Link_Publikasi
        $this->Link_Publikasi->AdvancedSearch->SearchValue = $filter["x_Link_Publikasi"] ?? "";
        $this->Link_Publikasi->AdvancedSearch->SearchOperator = $filter["z_Link_Publikasi"] ?? "";
        $this->Link_Publikasi->AdvancedSearch->SearchCondition = $filter["v_Link_Publikasi"] ?? "";
        $this->Link_Publikasi->AdvancedSearch->SearchValue2 = $filter["y_Link_Publikasi"] ?? "";
        $this->Link_Publikasi->AdvancedSearch->SearchOperator2 = $filter["w_Link_Publikasi"] ?? "";
        $this->Link_Publikasi->AdvancedSearch->save();
    ...
    public function basicSearchWhere(bool $default = false): string
    {
        ...
        $searchFlds = [];
        $searchFlds[] = &$this->NIM;
        $searchFlds[] = &$this->Judul_Penelitian;
        $searchFlds[] = &$this->Pembimbing_1;
        $searchFlds[] = &$this->Pembimbing_2;
        $searchFlds[] = &$this->Pembimbing_3;
        $searchFlds[] = &$this->Penguji_1;
        $searchFlds[] = &$this->Penguji_2;
        $searchFlds[] = &$this->Lembar_Pengesahan;
        $searchFlds[] = &$this->Judul_Publikasi;
        $searchFlds[] = &$this->Link_Publikasi;
        $searchFlds[] = &$this->user_id;
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Id_karya_ilmiah); // Id_karya_ilmiah
            $this->updateSort($this->NIM); // NIM
            $this->updateSort($this->Judul_Penelitian); // Judul_Penelitian
            $this->updateSort($this->Pembimbing_1); // Pembimbing_1
            $this->updateSort($this->Pembimbing_2); // Pembimbing_2
            $this->updateSort($this->Pembimbing_3); // Pembimbing_3
            $this->updateSort($this->Penguji_1); // Penguji_1
            $this->updateSort($this->Penguji_2); // Penguji_2
            $this->updateSort($this->Lembar_Pengesahan); // Lembar_Pengesahan
            $this->updateSort($this->Judul_Publikasi); // Judul_Publikasi
            $this->updateSort($this->Link_Publikasi); // Link_Publikasi
    ...
    protected function resetCmd(): void
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Id_karya_ilmiah->setSort("");
                $this->NIM->setSort("");
                $this->Judul_Penelitian->setSort("");
                $this->Pembimbing_1->setSort("");
                $this->Pembimbing_2->setSort("");
                $this->Pembimbing_3->setSort("");
                $this->Penguji_1->setSort("");
                $this->Penguji_2->setSort("");
                $this->Lembar_Pengesahan->setSort("");
                $this->Judul_Publikasi->setSort("");
                $this->Link_Publikasi->setSort("");
    ...
    public function renderListOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"karya_ilmiah\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $this->language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($this->security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"karya_ilmiah\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $this->language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($this->security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"karya_ilmiah\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("CopyLink") . "</a>";
                } else {
            ...
            foreach ($this->ListActions as $listAction) { // ActionType::SINGLE
                ...
                if ($listAction->Select == ActionType::SINGLE && $listAction->getVisible()) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                        "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fkarya_ilmiahlist\" data-key=\"" . $this->keyToJson(true) .
                    ...
                    if ($body == "") { // Setup first button
                        $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                            "\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fkarya_ilmiahlist\" data-key=\"" . $this->keyToJson(true) .
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->Id_karya_ilmiah->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"karya_ilmiah\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "Id_karya_ilmiah");
            $this->createColumnOption($option, "NIM");
            $this->createColumnOption($option, "Judul_Penelitian");
            $this->createColumnOption($option, "Pembimbing_1");
            $this->createColumnOption($option, "Pembimbing_2");
            $this->createColumnOption($option, "Pembimbing_3");
            $this->createColumnOption($option, "Penguji_1");
            $this->createColumnOption($option, "Penguji_2");
            $this->createColumnOption($option, "Lembar_Pengesahan");
            $this->createColumnOption($option, "Judul_Publikasi");
            $this->createColumnOption($option, "Link_Publikasi");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fkarya_ilmiahsrch\" data-ew-action=\"none\">" . $this->language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkarya_ilmiahsrch\" data-ew-action=\"none\">" . $this->language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions(): void
    {
        ...
        foreach ($this->ListActions as $listAction) { // ActionType::MULTIPLE
            if ($listAction->Select == ActionType::MULTIPLE && $listAction->getVisible()) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fkarya_ilmiahlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
                $item->Visible = true;
            }
        }
    ...
    public function setupRow(): void
    {
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_karya_ilmiah", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_karya_ilmiah",
...
// Load basic search values
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (ReadCookie('karya_ilmiah_searchpanel') == 'notactive' || ReadCookie('karya_ilmiah_searchpanel') == "") {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkarya_ilmiahsrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		} elseif (ReadCookie('karya_ilmiah_searchpanel') == 'active') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkarya_ilmiahsrch\" aria-pressed=\"true\">" . $this->language->phrase("SearchLink") . "</a>";
		} else {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkarya_ilmiahsrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
