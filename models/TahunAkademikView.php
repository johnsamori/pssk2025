 ...
 * Page class
 */
class TahunAkademikView extends TahunAkademik
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "TahunAkademikView";
    ...
    // CSS class/style
    public string $CurrentPageName = "tahunakademikview";
...
// Is modal
        ...
        if (($keyValue = Get("id_tahun") ?? Route("id_tahun")) !== null) {
            ...
            $this->RecKey["id_tahun"] = $this->id_tahun->QueryStringValue;
        } elseif (Post("id_tahun") !== null) {
            $this->id_tahun->setFormValue(Post("id_tahun"));
            $this->RecKey["id_tahun"] = $this->id_tahun->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_tahun->setQueryStringValue($keyValue);
            $this->RecKey["id_tahun"] = $this->id_tahun->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "tahunakademiklist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("tahunakademiklist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_tahun->CurrentValue, $this->CurrentRow['id_tahun'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "tahunakademiklist"; // No matching record, return to list
                    } else {
