 ...
 * Page class
 */
class TahunAkademikAdd extends TahunAkademik
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "TahunAkademikAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "tahunakademikadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "tahunakademikview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'id_tahun' first before field var 'x_id_tahun'
        $val = $this->hasFormValue("id_tahun") ? $this->getFormValue("id_tahun") : $this->getFormValue("x_id_tahun");
    }
