 ...
 * Page class
 */
class DetilUjianTahapBersamaDelete extends DetilUjianTahapBersama
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DetilUjianTahapBersamaDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "detilujiantahapbersamadelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("detilujiantahapbersamalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("detilujiantahapbersamalist"); // Return to list
                return;
            }
        }
