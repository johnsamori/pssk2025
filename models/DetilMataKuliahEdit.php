 ...
 * Page class
 */
class DetilMataKuliahEdit extends DetilMataKuliah
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "DetilMataKuliahEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "detilmatakuliahedit";
...
// Is modal
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_no") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_no->setQueryStringValue($keyValue);
                $this->id_no->setOldValue($this->id_no->QueryStringValue);
            } elseif (Post("id_no") !== null) {
                $this->id_no->setFormValue(Post("id_no"));
                $this->id_no->setOldValue($this->id_no->FormValue);
            } else {
