...
/**
 * Table class for kesehatan_mahasiswa
 */
class KesehatanMahasiswa extends DbTable implements LookupTableInterface
{
    ...
    // Fields
    public DbField $Id_kesehatan;
    public DbField $NIM;
    public DbField $Dokter_Penanggung_Jawab;
    public DbField $Nomor_SIP;
    public DbField $Diagnosa;
    public DbField $Rekomendasi_Dokter;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "kesehatan_mahasiswa"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Id_kesehatan
        $this->Id_kesehatan = new DbField(
            $this, // Table
            'x_Id_kesehatan', // Variable name
            'Id_kesehatan', // Name
            '`Id_kesehatan`', // Expression
            '`Id_kesehatan`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Id_kesehatan`', // Virtual expression
            false, // Is virtual
        ...
        $this->Id_kesehatan->InputTextType = "text";
        $this->Id_kesehatan->Raw = true;
        $this->Id_kesehatan->IsAutoIncrement = true; // Autoincrement field
        $this->Id_kesehatan->IsPrimaryKey = true; // Primary key field
        $this->Id_kesehatan->Nullable = false; // NOT NULL field
        $this->Id_kesehatan->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->Id_kesehatan->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['Id_kesehatan'] = &$this->Id_kesehatan;
        ...
        $this->Dokter_Penanggung_Jawab = new DbField(
            $this, // Table
            'x_Dokter_Penanggung_Jawab', // Variable name
            'Dokter_Penanggung_Jawab', // Name
            '`Dokter_Penanggung_Jawab`', // Expression
            '`Dokter_Penanggung_Jawab`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Dokter_Penanggung_Jawab`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Dokter_Penanggung_Jawab->InputTextType = "text";
        $this->Dokter_Penanggung_Jawab->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Dokter_Penanggung_Jawab'] = &$this->Dokter_Penanggung_Jawab;

        // Nomor_SIP
        $this->Nomor_SIP = new DbField(
            $this, // Table
            'x_Nomor_SIP', // Variable name
            'Nomor_SIP', // Name
            '`Nomor_SIP`', // Expression
            '`Nomor_SIP`', // Basic search expression
            200, // Type
            30, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Nomor_SIP`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Nomor_SIP->InputTextType = "text";
        $this->Nomor_SIP->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Nomor_SIP'] = &$this->Nomor_SIP;
        ...
        // Rekomendasi_Dokter
        $this->Rekomendasi_Dokter = new DbField(
            $this, // Table
            'x_Rekomendasi_Dokter', // Variable name
            'Rekomendasi_Dokter', // Name
            '`Rekomendasi_Dokter`', // Expression
            '`Rekomendasi_Dokter`', // Basic search expression
            200, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Rekomendasi_Dokter`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Rekomendasi_Dokter->InputTextType = "text";
        $this->Rekomendasi_Dokter->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Rekomendasi_Dokter'] = &$this->Rekomendasi_Dokter;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "kesehatan_mahasiswa";
    }
    ...
    public function insert(array &$row): int|bool
    {
        ...
        if ($result) {
            $this->Id_kesehatan->setDbValue($conn->lastInsertId());
            $row['Id_kesehatan'] = $this->Id_kesehatan->DbValue;
        }
        return $result;
    }
    ...
    public function update(array $row, string|array $where = "", ?array $old = null, bool $currentFilter = true): int|bool
    {
        ...
        if ($success) {
            if (!isset($row['Id_kesehatan']) && !IsEmpty($this->Id_kesehatan->CurrentValue)) {
                $row['Id_kesehatan'] = $this->Id_kesehatan->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(?array $row, string|array $where = ""): QueryBuilder
    {
        ...
        $where = is_array($where) ? $this->arrayToFilter($where) : $where;
        if ($row) {
            if (array_key_exists('Id_kesehatan', $row)) {
                AddFilter($where, QuotedName('Id_kesehatan', $this->Dbid) . '=' . QuotedValue($row['Id_kesehatan'], $this->Id_kesehatan->DataType, $this->Dbid));
            }
        }
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->Id_kesehatan->DbValue = $row['Id_kesehatan'];
        $this->NIM->DbValue = $row['NIM'];
        $this->Dokter_Penanggung_Jawab->DbValue = $row['Dokter_Penanggung_Jawab'];
        $this->Nomor_SIP->DbValue = $row['Nomor_SIP'];
        $this->Diagnosa->DbValue = $row['Diagnosa'];
        $this->Rekomendasi_Dokter->DbValue = $row['Rekomendasi_Dokter'];
    ...
    {
        return "`Id_kesehatan` = @Id_kesehatan@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->Id_kesehatan->CurrentValue : $this->Id_kesehatan->OldValue;
        if (IsEmpty($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey(string $key, bool $current = false, ?string $keySeparator = null): void
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->Id_kesehatan->CurrentValue = $keys[0];
            } else {
                $this->Id_kesehatan->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter(?array $row = null, bool $current = false): string
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('Id_kesehatan', $row) ? $row['Id_kesehatan'] : null;
        } else {
            $val = !IsEmpty($this->Id_kesehatan->OldValue) && !$current ? $this->Id_kesehatan->OldValue : $this->Id_kesehatan->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@Id_kesehatan@", AdjustSql($val), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("kesehatanmahasiswalist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "kesehatanmahasiswaview" => $this->language->phrase("View"),
            "kesehatanmahasiswaedit" => $this->language->phrase("Edit"),
            "kesehatanmahasiswaadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "KesehatanMahasiswaView",
            Config("API_ADD_ACTION") => "KesehatanMahasiswaAdd",
            Config("API_EDIT_ACTION") => "KesehatanMahasiswaEdit",
            Config("API_DELETE_ACTION") => "KesehatanMahasiswaDelete",
            Config("API_LIST_ACTION") => "KesehatanMahasiswaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("kesehatanmahasiswaview", $parm);
        } else {
            $url = $this->keyUrl("kesehatanmahasiswaview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "kesehatanmahasiswaadd?" . $parm;
        } else {
            $url = "kesehatanmahasiswaadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kesehatanmahasiswaedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kesehatanmahasiswalist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kesehatanmahasiswaadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kesehatanmahasiswalist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("kesehatanmahasiswadelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"Id_kesehatan\":" . VarToJson($this->Id_kesehatan->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->Id_kesehatan->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->Id_kesehatan->CurrentValue);
        } else {
    ...
    public function getRecordKeys(): array
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("Id_kesehatan") ?? Route("Id_kesehatan")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys(bool $setCurrent = true): string
    {
        ...
        foreach ($arKeys as $key) {
            if ($setCurrent) {
                $this->Id_kesehatan->CurrentValue = $key;
            } else {
                $this->Id_kesehatan->OldValue = $key;
            }
    ...
    public function renderListContent(string $filter)
    {
        global $Response;
        $container = Container();
        $listPage = "KesehatanMahasiswaList";
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->Id_kesehatan);
                    $doc->exportCaption($this->NIM);
                    $doc->exportCaption($this->Dokter_Penanggung_Jawab);
                    $doc->exportCaption($this->Nomor_SIP);
                    $doc->exportCaption($this->Diagnosa);
                    $doc->exportCaption($this->Rekomendasi_Dokter);
        ...
        while (($row = $result->fetchAssociative()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->Id_kesehatan);
                        $doc->exportField($this->NIM);
                        $doc->exportField($this->Dokter_Penanggung_Jawab);
                        $doc->exportField($this->Nomor_SIP);
                        $doc->exportField($this->Diagnosa);
                        $doc->exportField($this->Rekomendasi_Dokter);
