...
class AnnexView extends Annex
{
    ...
    // Page object name
    public string $PageObjName = "AnnexView";
    ...
    // CSS class/style
    public string $CurrentPageName = "annexview";
...
// Is modal
        ...
        if (($keyValue = Get("No") ?? Route("No")) !== null) {
            ...
            $returnUrl = "annexlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("annexlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->No->CurrentValue, $this->CurrentRow['No'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "annexlist"; // No matching record, return to list
                    } else {
