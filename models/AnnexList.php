...
class AnnexList extends Annex
{
    ...
    // Page object name
    public string $PageObjName = "AnnexList";
    ...
    public string $FormName = "fannexlist";

    // CSS class/style
    public string $CurrentPageName = "annexlist";
    ...
    public function setVisibility(): void
    {
        ...
        $this->Peraturan_Akdemik_Universitas->setVisibility();
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->setVisibility();
        $this->Rubrik_Penilaian->setVisibility();
        $this->Panduan_Penulisan_KTI->setVisibility();
    }
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        // Table object (annex)
        if (!isset($GLOBALS["annex"]) || $GLOBALS["annex"]::class == PROJECT_NAMESPACE . "annex") {
            $GLOBALS["annex"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "annexadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "annexdelete";
        $this->MultiUpdateUrl = "annexupdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'annex');
        }
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "annexview"); // If View page, no primary button
                } else { // List page
...
// Is modal
		...
		if (ReadCookie('annex_searchpanel') == 'notactive' || ReadCookie('annex_searchpanel') == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (ReadCookie('annex_searchpanel') == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fannexsrch");
        }
        $filterList = Concat($filterList, $this->No->AdvancedSearch->toJson(), ","); // Field No
        $filterList = Concat($filterList, $this->Peraturan_Akdemik_Universitas->AdvancedSearch->toJson(), ","); // Field Peraturan_Akdemik_Universitas
        $filterList = Concat($filterList, $this->Pedoman_Pelaksanaan_Peraturan_Akademik->AdvancedSearch->toJson(), ","); // Field Pedoman_Pelaksanaan_Peraturan_Akademik
        $filterList = Concat($filterList, $this->Rubrik_Penilaian->AdvancedSearch->toJson(), ","); // Field Rubrik_Penilaian
        $filterList = Concat($filterList, $this->Panduan_Penulisan_KTI->AdvancedSearch->toJson(), ","); // Field Panduan_Penulisan_KTI
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList(): bool
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fannexsrch", $filters);
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field Peraturan_Akdemik_Universitas
        $this->Peraturan_Akdemik_Universitas->AdvancedSearch->SearchValue = $filter["x_Peraturan_Akdemik_Universitas"] ?? "";
        $this->Peraturan_Akdemik_Universitas->AdvancedSearch->SearchOperator = $filter["z_Peraturan_Akdemik_Universitas"] ?? "";
        $this->Peraturan_Akdemik_Universitas->AdvancedSearch->SearchCondition = $filter["v_Peraturan_Akdemik_Universitas"] ?? "";
        $this->Peraturan_Akdemik_Universitas->AdvancedSearch->SearchValue2 = $filter["y_Peraturan_Akdemik_Universitas"] ?? "";
        $this->Peraturan_Akdemik_Universitas->AdvancedSearch->SearchOperator2 = $filter["w_Peraturan_Akdemik_Universitas"] ?? "";
        $this->Peraturan_Akdemik_Universitas->AdvancedSearch->save();

        // Field Pedoman_Pelaksanaan_Peraturan_Akademik
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->AdvancedSearch->SearchValue = $filter["x_Pedoman_Pelaksanaan_Peraturan_Akademik"] ?? "";
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->AdvancedSearch->SearchOperator = $filter["z_Pedoman_Pelaksanaan_Peraturan_Akademik"] ?? "";
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->AdvancedSearch->SearchCondition = $filter["v_Pedoman_Pelaksanaan_Peraturan_Akademik"] ?? "";
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->AdvancedSearch->SearchValue2 = $filter["y_Pedoman_Pelaksanaan_Peraturan_Akademik"] ?? "";
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->AdvancedSearch->SearchOperator2 = $filter["w_Pedoman_Pelaksanaan_Peraturan_Akademik"] ?? "";
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->AdvancedSearch->save();

        // Field Rubrik_Penilaian
        $this->Rubrik_Penilaian->AdvancedSearch->SearchValue = $filter["x_Rubrik_Penilaian"] ?? "";
        $this->Rubrik_Penilaian->AdvancedSearch->SearchOperator = $filter["z_Rubrik_Penilaian"] ?? "";
        $this->Rubrik_Penilaian->AdvancedSearch->SearchCondition = $filter["v_Rubrik_Penilaian"] ?? "";
        $this->Rubrik_Penilaian->AdvancedSearch->SearchValue2 = $filter["y_Rubrik_Penilaian"] ?? "";
        $this->Rubrik_Penilaian->AdvancedSearch->SearchOperator2 = $filter["w_Rubrik_Penilaian"] ?? "";
        $this->Rubrik_Penilaian->AdvancedSearch->save();

        // Field Panduan_Penulisan_KTI
        $this->Panduan_Penulisan_KTI->AdvancedSearch->SearchValue = $filter["x_Panduan_Penulisan_KTI"] ?? "";
        $this->Panduan_Penulisan_KTI->AdvancedSearch->SearchOperator = $filter["z_Panduan_Penulisan_KTI"] ?? "";
        $this->Panduan_Penulisan_KTI->AdvancedSearch->SearchCondition = $filter["v_Panduan_Penulisan_KTI"] ?? "";
        $this->Panduan_Penulisan_KTI->AdvancedSearch->SearchValue2 = $filter["y_Panduan_Penulisan_KTI"] ?? "";
        $this->Panduan_Penulisan_KTI->AdvancedSearch->SearchOperator2 = $filter["w_Panduan_Penulisan_KTI"] ?? "";
        $this->Panduan_Penulisan_KTI->AdvancedSearch->save();
    ...
    public function basicSearchWhere(bool $default = false): string
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->Peraturan_Akdemik_Universitas;
        $searchFlds[] = &$this->Pedoman_Pelaksanaan_Peraturan_Akademik;
        $searchFlds[] = &$this->Rubrik_Penilaian;
        $searchFlds[] = &$this->Panduan_Penulisan_KTI;
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Peraturan_Akdemik_Universitas); // Peraturan_Akdemik_Universitas
            $this->updateSort($this->Pedoman_Pelaksanaan_Peraturan_Akademik); // Pedoman_Pelaksanaan_Peraturan_Akademik
            $this->updateSort($this->Rubrik_Penilaian); // Rubrik_Penilaian
            $this->updateSort($this->Panduan_Penulisan_KTI); // Panduan_Penulisan_KTI
    ...
    protected function resetCmd(): void
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->No->setSort("");
                $this->Peraturan_Akdemik_Universitas->setSort("");
                $this->Pedoman_Pelaksanaan_Peraturan_Akademik->setSort("");
                $this->Rubrik_Penilaian->setSort("");
                $this->Panduan_Penulisan_KTI->setSort("");
            }
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"annex\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $this->language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($this->security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"annex\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $this->language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($this->security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"annex\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("CopyLink") . "</a>";
                } else {
            ...
            foreach ($this->ListActions as $listAction) { // ActionType::SINGLE
                ...
                if ($listAction->Select == ActionType::SINGLE && $listAction->getVisible()) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                        "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fannexlist\" data-key=\"" . $this->keyToJson(true) .
                    ...
                    if ($body == "") { // Setup first button
                        $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                            "\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fannexlist\" data-key=\"" . $this->keyToJson(true) .
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"annex\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "Peraturan_Akdemik_Universitas");
            $this->createColumnOption($option, "Pedoman_Pelaksanaan_Peraturan_Akademik");
            $this->createColumnOption($option, "Rubrik_Penilaian");
            $this->createColumnOption($option, "Panduan_Penulisan_KTI");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fannexsrch\" data-ew-action=\"none\">" . $this->language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fannexsrch\" data-ew-action=\"none\">" . $this->language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions(): void
    {
        ...
        foreach ($this->ListActions as $listAction) { // ActionType::MULTIPLE
            if ($listAction->Select == ActionType::MULTIPLE && $listAction->getVisible()) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fannexlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
                $item->Visible = true;
            }
        }
    ...
    public function setupRow(): void
    {
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_annex", "data-rowtype" => RowType::ADD]);
...
// Load basic search values
    ...
    public function loadRowValues(array|bool|null $row = null): void
    {
        ...
        $this->Peraturan_Akdemik_Universitas->setDbValue($row['Peraturan_Akdemik_Universitas']);
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->setDbValue($row['Pedoman_Pelaksanaan_Peraturan_Akademik']);
        $this->Rubrik_Penilaian->setDbValue($row['Rubrik_Penilaian']);
        $this->Panduan_Penulisan_KTI->setDbValue($row['Panduan_Penulisan_KTI']);
    }
    ...
    protected function newRow(): array
    {
        ...
        $row['Peraturan_Akdemik_Universitas'] = $this->Peraturan_Akdemik_Universitas->DefaultValue;
        $row['Pedoman_Pelaksanaan_Peraturan_Akademik'] = $this->Pedoman_Pelaksanaan_Peraturan_Akademik->DefaultValue;
        $row['Rubrik_Penilaian'] = $this->Rubrik_Penilaian->DefaultValue;
        $row['Panduan_Penulisan_KTI'] = $this->Panduan_Penulisan_KTI->DefaultValue;
        return $row;
    }
    ...
    public function renderRow(): void
    {
        ...
        // Peraturan_Akdemik_Universitas

        // Pedoman_Pelaksanaan_Peraturan_Akademik

        // Rubrik_Penilaian

        // Panduan_Penulisan_KTI
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // Peraturan_Akdemik_Universitas
            $this->Peraturan_Akdemik_Universitas->ViewValue = $this->Peraturan_Akdemik_Universitas->CurrentValue;

            // Pedoman_Pelaksanaan_Peraturan_Akademik
            $this->Pedoman_Pelaksanaan_Peraturan_Akademik->ViewValue = $this->Pedoman_Pelaksanaan_Peraturan_Akademik->CurrentValue;

            // Rubrik_Penilaian
            $this->Rubrik_Penilaian->ViewValue = $this->Rubrik_Penilaian->CurrentValue;

            // Panduan_Penulisan_KTI
            $this->Panduan_Penulisan_KTI->ViewValue = $this->Panduan_Penulisan_KTI->CurrentValue;
            ...
            // Peraturan_Akdemik_Universitas
            $this->Peraturan_Akdemik_Universitas->HrefValue = "";
            $this->Peraturan_Akdemik_Universitas->TooltipValue = "";

            // Pedoman_Pelaksanaan_Peraturan_Akademik
            $this->Pedoman_Pelaksanaan_Peraturan_Akademik->HrefValue = "";
            $this->Pedoman_Pelaksanaan_Peraturan_Akademik->TooltipValue = "";

            // Rubrik_Penilaian
            $this->Rubrik_Penilaian->HrefValue = "";
            $this->Rubrik_Penilaian->TooltipValue = "";

            // Panduan_Penulisan_KTI
            $this->Panduan_Penulisan_KTI->HrefValue = "";
            $this->Panduan_Penulisan_KTI->TooltipValue = "";
        }
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (ReadCookie('annex_searchpanel') == 'notactive' || ReadCookie('annex_searchpanel') == "") {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fannexsrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		} elseif (ReadCookie('annex_searchpanel') == 'active') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fannexsrch\" aria-pressed=\"true\">" . $this->language->phrase("SearchLink") . "</a>";
		} else {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fannexsrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
