 ...
 * Page class
 */
class PenyakitDelete extends Penyakit
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PenyakitDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "penyakitdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("penyakitlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("penyakitlist"); // Return to list
                return;
            }
        }
