 ...
 * Page class
 */
class MataKuliahDelete extends MataKuliah
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "MataKuliahDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "matakuliahdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("matakuliahlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("matakuliahlist"); // Return to list
                return;
            }
        }
