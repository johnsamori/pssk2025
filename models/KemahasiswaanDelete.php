 ...
 * Page class
 */
class KemahasiswaanDelete extends Kemahasiswaan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KemahasiswaanDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "kemahasiswaandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("kemahasiswaanlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("kemahasiswaanlist"); // Return to list
                return;
            }
        }
