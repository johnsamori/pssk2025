 ...
 * Page class
 */
class KesehatanMahasiswaList extends KesehatanMahasiswa
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "KesehatanMahasiswaList";
    ...
    public string $FormName = "fkesehatan_mahasiswalist";

    // CSS class/style
    public string $CurrentPageName = "kesehatanmahasiswalist";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        // Initialize URLs
        $this->AddUrl = "kesehatanmahasiswaadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "kesehatanmahasiswadelete";
        $this->MultiUpdateUrl = "kesehatanmahasiswaupdate";
...
// Is modal
        ...
        if ($this->IsModal) {
            $this->FormName = "fkesehatan_mahasiswagrid";
        }
		...
		if (ReadCookie('kesehatan_mahasiswa_searchpanel') == 'notactive' || ReadCookie('kesehatan_mahasiswa_searchpanel') == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (ReadCookie('kesehatan_mahasiswa_searchpanel') == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fkesehatan_mahasiswasrch");
        }
        $filterList = Concat($filterList, $this->Id_kesehatan->AdvancedSearch->toJson(), ","); // Field Id_kesehatan
        $filterList = Concat($filterList, $this->NIM->AdvancedSearch->toJson(), ","); // Field NIM
        $filterList = Concat($filterList, $this->Dokter_Penanggung_Jawab->AdvancedSearch->toJson(), ","); // Field Dokter_Penanggung_Jawab
        $filterList = Concat($filterList, $this->Nomor_SIP->AdvancedSearch->toJson(), ","); // Field Nomor_SIP
        $filterList = Concat($filterList, $this->Diagnosa->AdvancedSearch->toJson(), ","); // Field Diagnosa
        $filterList = Concat($filterList, $this->Rekomendasi_Dokter->AdvancedSearch->toJson(), ","); // Field Rekomendasi_Dokter
    ...
    protected function processFilterList(): bool
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fkesehatan_mahasiswasrch", $filters);
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field Id_kesehatan
        $this->Id_kesehatan->AdvancedSearch->SearchValue = $filter["x_Id_kesehatan"] ?? "";
        $this->Id_kesehatan->AdvancedSearch->SearchOperator = $filter["z_Id_kesehatan"] ?? "";
        $this->Id_kesehatan->AdvancedSearch->SearchCondition = $filter["v_Id_kesehatan"] ?? "";
        $this->Id_kesehatan->AdvancedSearch->SearchValue2 = $filter["y_Id_kesehatan"] ?? "";
        $this->Id_kesehatan->AdvancedSearch->SearchOperator2 = $filter["w_Id_kesehatan"] ?? "";
        $this->Id_kesehatan->AdvancedSearch->save();
        ...
        // Field Dokter_Penanggung_Jawab
        $this->Dokter_Penanggung_Jawab->AdvancedSearch->SearchValue = $filter["x_Dokter_Penanggung_Jawab"] ?? "";
        $this->Dokter_Penanggung_Jawab->AdvancedSearch->SearchOperator = $filter["z_Dokter_Penanggung_Jawab"] ?? "";
        $this->Dokter_Penanggung_Jawab->AdvancedSearch->SearchCondition = $filter["v_Dokter_Penanggung_Jawab"] ?? "";
        $this->Dokter_Penanggung_Jawab->AdvancedSearch->SearchValue2 = $filter["y_Dokter_Penanggung_Jawab"] ?? "";
        $this->Dokter_Penanggung_Jawab->AdvancedSearch->SearchOperator2 = $filter["w_Dokter_Penanggung_Jawab"] ?? "";
        $this->Dokter_Penanggung_Jawab->AdvancedSearch->save();

        // Field Nomor_SIP
        $this->Nomor_SIP->AdvancedSearch->SearchValue = $filter["x_Nomor_SIP"] ?? "";
        $this->Nomor_SIP->AdvancedSearch->SearchOperator = $filter["z_Nomor_SIP"] ?? "";
        $this->Nomor_SIP->AdvancedSearch->SearchCondition = $filter["v_Nomor_SIP"] ?? "";
        $this->Nomor_SIP->AdvancedSearch->SearchValue2 = $filter["y_Nomor_SIP"] ?? "";
        $this->Nomor_SIP->AdvancedSearch->SearchOperator2 = $filter["w_Nomor_SIP"] ?? "";
        $this->Nomor_SIP->AdvancedSearch->save();
        ...
        // Field Rekomendasi_Dokter
        $this->Rekomendasi_Dokter->AdvancedSearch->SearchValue = $filter["x_Rekomendasi_Dokter"] ?? "";
        $this->Rekomendasi_Dokter->AdvancedSearch->SearchOperator = $filter["z_Rekomendasi_Dokter"] ?? "";
        $this->Rekomendasi_Dokter->AdvancedSearch->SearchCondition = $filter["v_Rekomendasi_Dokter"] ?? "";
        $this->Rekomendasi_Dokter->AdvancedSearch->SearchValue2 = $filter["y_Rekomendasi_Dokter"] ?? "";
        $this->Rekomendasi_Dokter->AdvancedSearch->SearchOperator2 = $filter["w_Rekomendasi_Dokter"] ?? "";
        $this->Rekomendasi_Dokter->AdvancedSearch->save();
    ...
    public function basicSearchWhere(bool $default = false): string
    {
        ...
        $searchFlds = [];
        $searchFlds[] = &$this->NIM;
        $searchFlds[] = &$this->Dokter_Penanggung_Jawab;
        $searchFlds[] = &$this->Nomor_SIP;
        $searchFlds[] = &$this->Diagnosa;
        $searchFlds[] = &$this->Rekomendasi_Dokter;
        $searchFlds[] = &$this->Ip;
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Id_kesehatan); // Id_kesehatan
            $this->updateSort($this->NIM); // NIM
            $this->updateSort($this->Dokter_Penanggung_Jawab); // Dokter_Penanggung_Jawab
            $this->updateSort($this->Nomor_SIP); // Nomor_SIP
            $this->updateSort($this->Diagnosa); // Diagnosa
            $this->updateSort($this->Rekomendasi_Dokter); // Rekomendasi_Dokter
    ...
    protected function resetCmd(): void
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Id_kesehatan->setSort("");
                $this->NIM->setSort("");
                $this->Dokter_Penanggung_Jawab->setSort("");
                $this->Nomor_SIP->setSort("");
                $this->Diagnosa->setSort("");
                $this->Rekomendasi_Dokter->setSort("");
    ...
    public function renderListOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"kesehatan_mahasiswa\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $this->language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($this->security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"kesehatan_mahasiswa\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $this->language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($this->security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"kesehatan_mahasiswa\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("CopyLink") . "</a>";
                } else {
            ...
            foreach ($this->ListActions as $listAction) { // ActionType::SINGLE
                ...
                if ($listAction->Select == ActionType::SINGLE && $listAction->getVisible()) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                        "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fkesehatan_mahasiswalist\" data-key=\"" . $this->keyToJson(true) .
                    ...
                    if ($body == "") { // Setup first button
                        $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                            "\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fkesehatan_mahasiswalist\" data-key=\"" . $this->keyToJson(true) .
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->Id_kesehatan->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"kesehatan_mahasiswa\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "Id_kesehatan");
            $this->createColumnOption($option, "NIM");
            $this->createColumnOption($option, "Dokter_Penanggung_Jawab");
            $this->createColumnOption($option, "Nomor_SIP");
            $this->createColumnOption($option, "Diagnosa");
            $this->createColumnOption($option, "Rekomendasi_Dokter");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fkesehatan_mahasiswasrch\" data-ew-action=\"none\">" . $this->language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkesehatan_mahasiswasrch\" data-ew-action=\"none\">" . $this->language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions(): void
    {
        ...
        foreach ($this->ListActions as $listAction) { // ActionType::MULTIPLE
            if ($listAction->Select == ActionType::MULTIPLE && $listAction->getVisible()) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fkesehatan_mahasiswalist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
                $item->Visible = true;
            }
        }
    ...
    public function setupRow(): void
    {
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_kesehatan_mahasiswa", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_kesehatan_mahasiswa",
...
// Load basic search values
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->Id_kesehatan->TooltipValue = "";
            ...
            $this->Dokter_Penanggung_Jawab->TooltipValue = "";

            // Nomor_SIP
            $this->Nomor_SIP->HrefValue = "";
            $this->Nomor_SIP->TooltipValue = "";
            ...
            $this->Rekomendasi_Dokter->TooltipValue = "";
        }
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (ReadCookie('kesehatan_mahasiswa_searchpanel') == 'notactive' || ReadCookie('kesehatan_mahasiswa_searchpanel') == "") {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkesehatan_mahasiswasrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		} elseif (ReadCookie('kesehatan_mahasiswa_searchpanel') == 'active') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkesehatan_mahasiswasrch\" aria-pressed=\"true\">" . $this->language->phrase("SearchLink") . "</a>";
		} else {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkesehatan_mahasiswasrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
