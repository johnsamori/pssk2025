 ...
 * Page class
 */
class KesehatanMahasiswaView extends KesehatanMahasiswa
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KesehatanMahasiswaView";
    ...
    // CSS class/style
    public string $CurrentPageName = "kesehatanmahasiswaview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("Id_kesehatan") ?? Route("Id_kesehatan")) !== null) {
            $this->RecKey["Id_kesehatan"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("Id_kesehatan") ?? Route("Id_kesehatan")) !== null) {
            ...
            $this->RecKey["Id_kesehatan"] = $this->Id_kesehatan->QueryStringValue;
        } elseif (Post("Id_kesehatan") !== null) {
            $this->Id_kesehatan->setFormValue(Post("Id_kesehatan"));
            $this->RecKey["Id_kesehatan"] = $this->Id_kesehatan->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Id_kesehatan->setQueryStringValue($keyValue);
            $this->RecKey["Id_kesehatan"] = $this->Id_kesehatan->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "kesehatanmahasiswalist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kesehatanmahasiswalist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Id_kesehatan->CurrentValue, $this->CurrentRow['Id_kesehatan'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "kesehatanmahasiswalist"; // No matching record, return to list
                    } else {
