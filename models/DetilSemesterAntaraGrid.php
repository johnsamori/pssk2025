 ...
 * Page class
 */
class DetilSemesterAntaraGrid extends DetilSemesterAntara
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "DetilSemesterAntaraGrid";
    ...
    public string $FormName = "fdetil_semester_antaragrid";

    // CSS class/style
    public string $CurrentPageName = "detilsemesterantaragrid";
...
// Use layout
    ...
    protected function setupListOptions(): void
    {
        ...
        $item->CssClass = "text-nowrap";
        $item->Visible = $this->security->allowView(CurrentProjectID() . 'detil_semester_antara');
        $item->OnLeft = true;

        // "edit"
        $item = &$this->ListOptions->add("edit");
        $item->CssClass = "text-nowrap";
        $item->Visible = $this->security->allowEdit(CurrentProjectID() . 'detil_semester_antara');
        $item->OnLeft = true;

        // "copy"
        $item = &$this->ListOptions->add("copy");
        $item->CssClass = "text-nowrap";
        $item->Visible = $this->security->allowAdd(CurrentProjectID() . 'detil_semester_antara');
        $item->OnLeft = true;

        // "delete"
        $item = &$this->ListOptions->add("delete");
        $item->CssClass = "text-nowrap";
        $item->Visible = $this->security->allowDelete(CurrentProjectID() . 'detil_semester_antara');
        $item->OnLeft = true;
    ...
    public function renderListOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->allowView(CurrentProjectID() . 'detil_semester_antara')) {
            ...
            if ($this->security->allowEdit(CurrentProjectID() . 'detil_semester_antara')) {
            ...
            if ($this->security->allowAdd(CurrentProjectID() . 'detil_semester_antara')) {
            ...
            if ($this->security->allowDelete(CurrentProjectID() . 'detil_semester_antara')) {
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") { // Check view mode
            ...
            $item->Visible = $this->AddUrl != "" && $this->security->allowAdd(CurrentProjectID() . 'detil_semester_antara');
        }
    }
...
// Get upload files
    ...
    {
        $this->Bukti_SPP->Upload->Index = $this->RowIndex;
    }
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->getCurrentMasterTable() == "semester_antara") {
            $this->id_smtsr->Visible = true; // Need to insert foreign key
            $this->id_smtsr->CurrentValue = $this->id_smtsr->getSessionValue();
        }
