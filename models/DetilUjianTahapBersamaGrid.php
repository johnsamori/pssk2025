 ...
 * Page class
 */
class DetilUjianTahapBersamaGrid extends DetilUjianTahapBersama
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "DetilUjianTahapBersamaGrid";
    ...
    public string $FormName = "fdetil_ujian_tahap_bersamagrid";

    // CSS class/style
    public string $CurrentPageName = "detilujiantahapbersamagrid";
...
// Use layout
    ...
    protected function setupListOptions(): void
    {
        ...
        $item->CssClass = "text-nowrap";
        $item->Visible = $this->security->allowView(CurrentProjectID() . 'detil_ujian_tahap_bersama');
        $item->OnLeft = true;

        // "edit"
        $item = &$this->ListOptions->add("edit");
        $item->CssClass = "text-nowrap";
        $item->Visible = $this->security->allowEdit(CurrentProjectID() . 'detil_ujian_tahap_bersama');
        $item->OnLeft = true;

        // "copy"
        $item = &$this->ListOptions->add("copy");
        $item->CssClass = "text-nowrap";
        $item->Visible = $this->security->allowAdd(CurrentProjectID() . 'detil_ujian_tahap_bersama');
        $item->OnLeft = true;

        // "delete"
        $item = &$this->ListOptions->add("delete");
        $item->CssClass = "text-nowrap";
        $item->Visible = $this->security->allowDelete(CurrentProjectID() . 'detil_ujian_tahap_bersama');
        $item->OnLeft = true;
    ...
    public function renderListOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->allowView(CurrentProjectID() . 'detil_ujian_tahap_bersama')) {
            ...
            if ($this->security->allowEdit(CurrentProjectID() . 'detil_ujian_tahap_bersama')) {
            ...
            if ($this->security->allowAdd(CurrentProjectID() . 'detil_ujian_tahap_bersama')) {
            ...
            if ($this->security->allowDelete(CurrentProjectID() . 'detil_ujian_tahap_bersama')) {
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") { // Check view mode
            ...
            $item->Visible = $this->AddUrl != "" && $this->security->allowAdd(CurrentProjectID() . 'detil_ujian_tahap_bersama');
        }
    }
...
// Get upload files
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->getCurrentMasterTable() == "ujian_tahap_bersama") {
            $this->id_utb->Visible = true; // Need to insert foreign key
            $this->id_utb->CurrentValue = $this->id_utb->getSessionValue();
        }
