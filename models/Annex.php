...
/**
 * Table class for annex
 */
class Annex extends DbTable implements LookupTableInterface
{
    ...
    // Fields
    public DbField $No;
    public DbField $Peraturan_Akdemik_Universitas;
    public DbField $Pedoman_Pelaksanaan_Peraturan_Akademik;
    public DbField $Rubrik_Penilaian;
    public DbField $Panduan_Penulisan_KTI;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "annex"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->Peraturan_Akdemik_Universitas = new DbField(
            $this, // Table
            'x_Peraturan_Akdemik_Universitas', // Variable name
            'Peraturan_Akdemik_Universitas', // Name
            '`Peraturan_Akdemik_Universitas`', // Expression
            '`Peraturan_Akdemik_Universitas`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Peraturan_Akdemik_Universitas`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Peraturan_Akdemik_Universitas->InputTextType = "text";
        $this->Peraturan_Akdemik_Universitas->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Peraturan_Akdemik_Universitas'] = &$this->Peraturan_Akdemik_Universitas;

        // Pedoman_Pelaksanaan_Peraturan_Akademik
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik = new DbField(
            $this, // Table
            'x_Pedoman_Pelaksanaan_Peraturan_Akademik', // Variable name
            'Pedoman_Pelaksanaan_Peraturan_Akademik', // Name
            '`Pedoman_Pelaksanaan_Peraturan_Akademik`', // Expression
            '`Pedoman_Pelaksanaan_Peraturan_Akademik`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Pedoman_Pelaksanaan_Peraturan_Akademik`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->InputTextType = "text";
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Pedoman_Pelaksanaan_Peraturan_Akademik'] = &$this->Pedoman_Pelaksanaan_Peraturan_Akademik;

        // Rubrik_Penilaian
        $this->Rubrik_Penilaian = new DbField(
            $this, // Table
            'x_Rubrik_Penilaian', // Variable name
            'Rubrik_Penilaian', // Name
            '`Rubrik_Penilaian`', // Expression
            '`Rubrik_Penilaian`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Rubrik_Penilaian`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Rubrik_Penilaian->InputTextType = "text";
        $this->Rubrik_Penilaian->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Rubrik_Penilaian'] = &$this->Rubrik_Penilaian;

        // Panduan_Penulisan_KTI
        $this->Panduan_Penulisan_KTI = new DbField(
            $this, // Table
            'x_Panduan_Penulisan_KTI', // Variable name
            'Panduan_Penulisan_KTI', // Name
            '`Panduan_Penulisan_KTI`', // Expression
            '`Panduan_Penulisan_KTI`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Panduan_Penulisan_KTI`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Panduan_Penulisan_KTI->InputTextType = "text";
        $this->Panduan_Penulisan_KTI->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Panduan_Penulisan_KTI'] = &$this->Panduan_Penulisan_KTI;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "annex";
    }
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->Peraturan_Akdemik_Universitas->DbValue = $row['Peraturan_Akdemik_Universitas'];
        $this->Pedoman_Pelaksanaan_Peraturan_Akademik->DbValue = $row['Pedoman_Pelaksanaan_Peraturan_Akademik'];
        $this->Rubrik_Penilaian->DbValue = $row['Rubrik_Penilaian'];
        $this->Panduan_Penulisan_KTI->DbValue = $row['Panduan_Penulisan_KTI'];
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("annexlist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "annexview" => $this->language->phrase("View"),
            "annexedit" => $this->language->phrase("Edit"),
            "annexadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "AnnexView",
            Config("API_ADD_ACTION") => "AnnexAdd",
            Config("API_EDIT_ACTION") => "AnnexEdit",
            Config("API_DELETE_ACTION") => "AnnexDelete",
            Config("API_LIST_ACTION") => "AnnexList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("annexview", $parm);
        } else {
            $url = $this->keyUrl("annexview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("annexedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("annexlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("annexlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("annexdelete", $parm);
        }
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->Peraturan_Akdemik_Universitas);
                    $doc->exportCaption($this->Pedoman_Pelaksanaan_Peraturan_Akademik);
                    $doc->exportCaption($this->Rubrik_Penilaian);
                    $doc->exportCaption($this->Panduan_Penulisan_KTI);
                } else {
                    $doc->exportCaption($this->No);
                    $doc->exportCaption($this->Peraturan_Akdemik_Universitas);
                    $doc->exportCaption($this->Pedoman_Pelaksanaan_Peraturan_Akademik);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->Peraturan_Akdemik_Universitas);
                        $doc->exportField($this->Pedoman_Pelaksanaan_Peraturan_Akademik);
                        $doc->exportField($this->Rubrik_Penilaian);
                        $doc->exportField($this->Panduan_Penulisan_KTI);
                    } else {
                        $doc->exportField($this->No);
                        $doc->exportField($this->Peraturan_Akdemik_Universitas);
                        $doc->exportField($this->Pedoman_Pelaksanaan_Peraturan_Akademik);
