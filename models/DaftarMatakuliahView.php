 ...
 * Page class
 */
class DaftarMatakuliahView extends DaftarMatakuliah
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DaftarMatakuliahView";
    ...
    // CSS class/style
    public string $CurrentPageName = "daftarmatakuliahview";
...
// Is modal
        ...
        if (($keyValue = Get("Kode") ?? Route("Kode")) !== null) {
            ...
            $returnUrl = "daftarmatakuliahlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("daftarmatakuliahlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Kode->CurrentValue, $this->CurrentRow['Kode'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "daftarmatakuliahlist"; // No matching record, return to list
                    } else {
