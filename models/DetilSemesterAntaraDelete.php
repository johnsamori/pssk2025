 ...
 * Page class
 */
class DetilSemesterAntaraDelete extends DetilSemesterAntara
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DetilSemesterAntaraDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "detilsemesterantaradelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("detilsemesterantaralist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("detilsemesterantaralist"); // Return to list
                return;
            }
        }
