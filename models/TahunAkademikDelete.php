 ...
 * Page class
 */
class TahunAkademikDelete extends TahunAkademik
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "TahunAkademikDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "tahunakademikdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("tahunakademiklist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("tahunakademiklist"); // Return to list
                return;
            }
        }
