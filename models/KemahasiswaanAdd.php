 ...
 * Page class
 */
class KemahasiswaanAdd extends Kemahasiswaan
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "KemahasiswaanAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "kemahasiswaanadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "kemahasiswaanview") {
...
// Get upload files
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if (strval($this->id_kemahasiswaan->EditValue) != "" && is_numeric($this->id_kemahasiswaan->EditValue)) {
                $this->id_kemahasiswaan->EditValue = FormatNumber($this->id_kemahasiswaan->EditValue, null);
            }
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->id_kemahasiswaan->CurrentValue != "") { // Check field with unique index
            $filter = "(`id_kemahasiswaan` = " . AdjustSql($this->id_kemahasiswaan->CurrentValue) . ")";
        ...
        if ($insertRow && $this->ValidateKey && strval($newRow['id_kemahasiswaan']) == "") {
    ...
    protected function getAddRow(): array
    {
        ...
        // id_kemahasiswaan
        $this->id_kemahasiswaan->setDbValueDef($newRow, $this->id_kemahasiswaan->CurrentValue, false);

        // NIM
        $this->NIM->setDbValueDef($newRow, $this->NIM->CurrentValue, false);

        // Jenis_Beasiswa
        $this->Jenis_Beasiswa->setDbValueDef($newRow, $this->Jenis_Beasiswa->CurrentValue, false);

        // Sumber_beasiswa
        $this->Sumber_beasiswa->setDbValueDef($newRow, $this->Sumber_beasiswa->CurrentValue, false);

        // Nama_Kegiatan
        $this->Nama_Kegiatan->setDbValueDef($newRow, $this->Nama_Kegiatan->CurrentValue, false);

        // Nama_Penghargaan_Yang Diterima
        $this->Nama_Penghargaan_YangDiterima->setDbValueDef($newRow, $this->Nama_Penghargaan_YangDiterima->CurrentValue, false);

        // Sertifikat
        $this->Sertifikat->setDbValueDef($newRow, $this->Sertifikat->CurrentValue, false);

        // userid
        $this->userid->CurrentValue = $this->userid->getAutoUpdateValue(); // PHP
        $this->userid->setDbValueDef($newRow, $this->userid->CurrentValue, false);
