 ...
 * Page class
 */
class PembimbinganAdd extends Pembimbingan
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "PembimbinganAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "pembimbinganadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "pembimbinganview") {
...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'id_pem' first before field var 'x_id_pem'
        $val = $this->hasFormValue("id_pem") ? $this->getFormValue("id_pem") : $this->getFormValue("x_id_pem");
    }
    ...
    protected function getAddRow(): array
    {
        ...
        // NIP_Dosen_Pembimbing
        $this->NIP_Dosen_Pembimbing->setDbValueDef($newRow, $this->NIP_Dosen_Pembimbing->CurrentValue, false);

        // NIM
        $this->NIM->setDbValueDef($newRow, $this->NIM->CurrentValue, false);

        // Catatan_Mahasiswa
        $this->Catatan_Mahasiswa->setDbValueDef($newRow, $this->Catatan_Mahasiswa->CurrentValue, false);

        // Catatan_Dosen_Wali
        $this->Catatan_Dosen_Wali->setDbValueDef($newRow, $this->Catatan_Dosen_Wali->CurrentValue, false);

        // Rekomendasi_Unit_BK
        $this->Rekomendasi_Unit_BK->setDbValueDef($newRow, $this->Rekomendasi_Unit_BK->CurrentValue, false);

        // Nilai_IP_Semester
        $this->Nilai_IP_Semester->setDbValueDef($newRow, $this->Nilai_IP_Semester->CurrentValue, false);

        // Nilai_IPK
        $this->Nilai_IPK->setDbValueDef($newRow, $this->Nilai_IPK->CurrentValue, false);

        // Surat_Peringatan
        $this->Surat_Peringatan->setDbValueDef($newRow, $this->Surat_Peringatan->CurrentValue, false);

        // Surat_Pemberitahuan
        $this->Surat_Pemberitahuan->setDbValueDef($newRow, $this->Surat_Pemberitahuan->CurrentValue, false);

        // Rekomendasi_Akhir
        $this->Rekomendasi_Akhir->setDbValueDef($newRow, $this->Rekomendasi_Akhir->CurrentValue, false);
