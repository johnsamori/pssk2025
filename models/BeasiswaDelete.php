 ...
 * Page class
 */
class BeasiswaDelete extends Beasiswa
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "BeasiswaDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "beasiswadelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("beasiswalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("beasiswalist"); // Return to list
                return;
            }
        }
