 ...
 * Page class
 */
class BeasiswaView extends Beasiswa
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "BeasiswaView";
    ...
    // CSS class/style
    public string $CurrentPageName = "beasiswaview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_beasiswa") ?? Route("id_beasiswa")) !== null) {
            $this->RecKey["id_beasiswa"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_beasiswa") ?? Route("id_beasiswa")) !== null) {
            ...
            $this->RecKey["id_beasiswa"] = $this->id_beasiswa->QueryStringValue;
        } elseif (Post("id_beasiswa") !== null) {
            $this->id_beasiswa->setFormValue(Post("id_beasiswa"));
            $this->RecKey["id_beasiswa"] = $this->id_beasiswa->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_beasiswa->setQueryStringValue($keyValue);
            $this->RecKey["id_beasiswa"] = $this->id_beasiswa->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "beasiswalist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("beasiswalist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_beasiswa->CurrentValue, $this->CurrentRow['id_beasiswa'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "beasiswalist"; // No matching record, return to list
                    } else {
