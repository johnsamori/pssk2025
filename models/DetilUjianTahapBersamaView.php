 ...
 * Page class
 */
class DetilUjianTahapBersamaView extends DetilUjianTahapBersama
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DetilUjianTahapBersamaView";
    ...
    // CSS class/style
    public string $CurrentPageName = "detilujiantahapbersamaview";
...
// Is modal
        ...
        if (($keyValue = Get("no") ?? Route("no")) !== null) {
            ...
            $returnUrl = "detilujiantahapbersamalist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("detilujiantahapbersamalist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "detilujiantahapbersamalist"; // No matching record, return to list
                    } else {
