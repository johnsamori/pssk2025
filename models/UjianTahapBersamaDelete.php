 ...
 * Page class
 */
class UjianTahapBersamaDelete extends UjianTahapBersama
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "UjianTahapBersamaDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "ujiantahapbersamadelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("ujiantahapbersamalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("ujiantahapbersamalist"); // Return to list
                return;
            }
        }
