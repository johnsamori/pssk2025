 ...
 * Page class
 */
class CutiAkademikList extends CutiAkademik
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "CutiAkademikList";
    ...
    public string $FormName = "fcuti_akademiklist";

    // CSS class/style
    public string $CurrentPageName = "cutiakademiklist";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        // Initialize URLs
        $this->AddUrl = "cutiakademikadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "cutiakademikdelete";
        $this->MultiUpdateUrl = "cutiakademikupdate";
...
// Is modal
        ...
        if ($this->IsModal) {
            $this->FormName = "fcuti_akademikgrid";
        }
		...
		if (ReadCookie('cuti_akademik_searchpanel') == 'notactive' || ReadCookie('cuti_akademik_searchpanel') == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (ReadCookie('cuti_akademik_searchpanel') == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fcuti_akademiksrch");
        }
        $filterList = Concat($filterList, $this->id_ca->AdvancedSearch->toJson(), ","); // Field id_ca
        $filterList = Concat($filterList, $this->NIM->AdvancedSearch->toJson(), ","); // Field NIM
        $filterList = Concat($filterList, $this->Pengajuan_Surat_Cuti_Akademik->AdvancedSearch->toJson(), ","); // Field Pengajuan_Surat_Cuti_Akademik
        $filterList = Concat($filterList, $this->Persetujuan_Cuti_Akademik->AdvancedSearch->toJson(), ","); // Field Persetujuan_Cuti_Akademik
        $filterList = Concat($filterList, $this->Surat_Keterangan_Aktif_Kembali->AdvancedSearch->toJson(), ","); // Field Surat_Keterangan_Aktif_Kembali
    ...
    protected function processFilterList(): bool
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fcuti_akademiksrch", $filters);
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field id_ca
        $this->id_ca->AdvancedSearch->SearchValue = $filter["x_id_ca"] ?? "";
        $this->id_ca->AdvancedSearch->SearchOperator = $filter["z_id_ca"] ?? "";
        $this->id_ca->AdvancedSearch->SearchCondition = $filter["v_id_ca"] ?? "";
        $this->id_ca->AdvancedSearch->SearchValue2 = $filter["y_id_ca"] ?? "";
        $this->id_ca->AdvancedSearch->SearchOperator2 = $filter["w_id_ca"] ?? "";
        $this->id_ca->AdvancedSearch->save();
        ...
        // Field Pengajuan_Surat_Cuti_Akademik
        $this->Pengajuan_Surat_Cuti_Akademik->AdvancedSearch->SearchValue = $filter["x_Pengajuan_Surat_Cuti_Akademik"] ?? "";
        $this->Pengajuan_Surat_Cuti_Akademik->AdvancedSearch->SearchOperator = $filter["z_Pengajuan_Surat_Cuti_Akademik"] ?? "";
        $this->Pengajuan_Surat_Cuti_Akademik->AdvancedSearch->SearchCondition = $filter["v_Pengajuan_Surat_Cuti_Akademik"] ?? "";
        $this->Pengajuan_Surat_Cuti_Akademik->AdvancedSearch->SearchValue2 = $filter["y_Pengajuan_Surat_Cuti_Akademik"] ?? "";
        $this->Pengajuan_Surat_Cuti_Akademik->AdvancedSearch->SearchOperator2 = $filter["w_Pengajuan_Surat_Cuti_Akademik"] ?? "";
        $this->Pengajuan_Surat_Cuti_Akademik->AdvancedSearch->save();

        // Field Persetujuan_Cuti_Akademik
        $this->Persetujuan_Cuti_Akademik->AdvancedSearch->SearchValue = $filter["x_Persetujuan_Cuti_Akademik"] ?? "";
        $this->Persetujuan_Cuti_Akademik->AdvancedSearch->SearchOperator = $filter["z_Persetujuan_Cuti_Akademik"] ?? "";
        $this->Persetujuan_Cuti_Akademik->AdvancedSearch->SearchCondition = $filter["v_Persetujuan_Cuti_Akademik"] ?? "";
        $this->Persetujuan_Cuti_Akademik->AdvancedSearch->SearchValue2 = $filter["y_Persetujuan_Cuti_Akademik"] ?? "";
        $this->Persetujuan_Cuti_Akademik->AdvancedSearch->SearchOperator2 = $filter["w_Persetujuan_Cuti_Akademik"] ?? "";
        $this->Persetujuan_Cuti_Akademik->AdvancedSearch->save();

        // Field Surat_Keterangan_Aktif_Kembali
        $this->Surat_Keterangan_Aktif_Kembali->AdvancedSearch->SearchValue = $filter["x_Surat_Keterangan_Aktif_Kembali"] ?? "";
        $this->Surat_Keterangan_Aktif_Kembali->AdvancedSearch->SearchOperator = $filter["z_Surat_Keterangan_Aktif_Kembali"] ?? "";
        $this->Surat_Keterangan_Aktif_Kembali->AdvancedSearch->SearchCondition = $filter["v_Surat_Keterangan_Aktif_Kembali"] ?? "";
        $this->Surat_Keterangan_Aktif_Kembali->AdvancedSearch->SearchValue2 = $filter["y_Surat_Keterangan_Aktif_Kembali"] ?? "";
        $this->Surat_Keterangan_Aktif_Kembali->AdvancedSearch->SearchOperator2 = $filter["w_Surat_Keterangan_Aktif_Kembali"] ?? "";
        $this->Surat_Keterangan_Aktif_Kembali->AdvancedSearch->save();
    ...
    public function basicSearchWhere(bool $default = false): string
    {
        ...
        $searchFlds = [];
        $searchFlds[] = &$this->NIM;
        $searchFlds[] = &$this->Pengajuan_Surat_Cuti_Akademik;
        $searchFlds[] = &$this->Persetujuan_Cuti_Akademik;
        $searchFlds[] = &$this->Surat_Keterangan_Aktif_Kembali;
        $searchFlds[] = &$this->id_user;
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->id_ca); // id_ca
            $this->updateSort($this->NIM); // NIM
            $this->updateSort($this->Pengajuan_Surat_Cuti_Akademik); // Pengajuan_Surat_Cuti_Akademik
            $this->updateSort($this->Persetujuan_Cuti_Akademik); // Persetujuan_Cuti_Akademik
            $this->updateSort($this->Surat_Keterangan_Aktif_Kembali); // Surat_Keterangan_Aktif_Kembali
    ...
    protected function resetCmd(): void
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id_ca->setSort("");
                $this->NIM->setSort("");
                $this->Pengajuan_Surat_Cuti_Akademik->setSort("");
                $this->Persetujuan_Cuti_Akademik->setSort("");
                $this->Surat_Keterangan_Aktif_Kembali->setSort("");
    ...
    public function renderListOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"cuti_akademik\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $this->language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($this->security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"cuti_akademik\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $this->language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($this->security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"cuti_akademik\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("CopyLink") . "</a>";
                } else {
            ...
            foreach ($this->ListActions as $listAction) { // ActionType::SINGLE
                ...
                if ($listAction->Select == ActionType::SINGLE && $listAction->getVisible()) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                        "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fcuti_akademiklist\" data-key=\"" . $this->keyToJson(true) .
                    ...
                    if ($body == "") { // Setup first button
                        $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                            "\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fcuti_akademiklist\" data-key=\"" . $this->keyToJson(true) .
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->id_ca->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"cuti_akademik\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "id_ca");
            $this->createColumnOption($option, "NIM");
            $this->createColumnOption($option, "Pengajuan_Surat_Cuti_Akademik");
            $this->createColumnOption($option, "Persetujuan_Cuti_Akademik");
            $this->createColumnOption($option, "Surat_Keterangan_Aktif_Kembali");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fcuti_akademiksrch\" data-ew-action=\"none\">" . $this->language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcuti_akademiksrch\" data-ew-action=\"none\">" . $this->language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions(): void
    {
        ...
        foreach ($this->ListActions as $listAction) { // ActionType::MULTIPLE
            if ($listAction->Select == ActionType::MULTIPLE && $listAction->getVisible()) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fcuti_akademiklist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
                $item->Visible = true;
            }
        }
    ...
    public function setupRow(): void
    {
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_cuti_akademik", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_cuti_akademik",
...
// Load basic search values
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->Pengajuan_Surat_Cuti_Akademik->TooltipValue = "";

            // Persetujuan_Cuti_Akademik
            $this->Persetujuan_Cuti_Akademik->HrefValue = "";
            $this->Persetujuan_Cuti_Akademik->TooltipValue = "";

            // Surat_Keterangan_Aktif_Kembali
            $this->Surat_Keterangan_Aktif_Kembali->HrefValue = "";
            $this->Surat_Keterangan_Aktif_Kembali->TooltipValue = "";
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (ReadCookie('cuti_akademik_searchpanel') == 'notactive' || ReadCookie('cuti_akademik_searchpanel') == "") {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fcuti_akademiksrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		} elseif (ReadCookie('cuti_akademik_searchpanel') == 'active') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fcuti_akademiksrch\" aria-pressed=\"true\">" . $this->language->phrase("SearchLink") . "</a>";
		} else {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fcuti_akademiksrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
