 ...
 * Page class
 */
class KemahasiswaanView extends Kemahasiswaan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KemahasiswaanView";
    ...
    // CSS class/style
    public string $CurrentPageName = "kemahasiswaanview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_kemahasiswaan") ?? Route("id_kemahasiswaan")) !== null) {
            $this->RecKey["id_kemahasiswaan"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_kemahasiswaan") ?? Route("id_kemahasiswaan")) !== null) {
            ...
            $this->RecKey["id_kemahasiswaan"] = $this->id_kemahasiswaan->QueryStringValue;
        } elseif (Post("id_kemahasiswaan") !== null) {
            $this->id_kemahasiswaan->setFormValue(Post("id_kemahasiswaan"));
            $this->RecKey["id_kemahasiswaan"] = $this->id_kemahasiswaan->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_kemahasiswaan->setQueryStringValue($keyValue);
            $this->RecKey["id_kemahasiswaan"] = $this->id_kemahasiswaan->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "kemahasiswaanlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kemahasiswaanlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_kemahasiswaan->CurrentValue, $this->CurrentRow['id_kemahasiswaan'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "kemahasiswaanlist"; // No matching record, return to list
                    } else {
