 ...
 * Page class
 */
class CutiAkademikDelete extends CutiAkademik
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "CutiAkademikDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "cutiakademikdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("cutiakademiklist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("cutiakademiklist"); // Return to list
                return;
            }
        }
