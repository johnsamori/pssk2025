 ...
 * Page class
 */
class CutiAkademikView extends CutiAkademik
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "CutiAkademikView";
    ...
    // CSS class/style
    public string $CurrentPageName = "cutiakademikview";
...
// Is modal
        ...
        if (($keyValue = Get("id_ca") ?? Route("id_ca")) !== null) {
            ...
            $this->RecKey["id_ca"] = $this->id_ca->QueryStringValue;
        } elseif (Post("id_ca") !== null) {
            $this->id_ca->setFormValue(Post("id_ca"));
            $this->RecKey["id_ca"] = $this->id_ca->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_ca->setQueryStringValue($keyValue);
            $this->RecKey["id_ca"] = $this->id_ca->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "cutiakademiklist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("cutiakademiklist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_ca->CurrentValue, $this->CurrentRow['id_ca'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "cutiakademiklist"; // No matching record, return to list
                    } else {
