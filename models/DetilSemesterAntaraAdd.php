 ...
 * Page class
 */
class DetilSemesterAntaraAdd extends DetilSemesterAntara
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "DetilSemesterAntaraAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "detilsemesterantaraadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "detilsemesterantaraview") {
