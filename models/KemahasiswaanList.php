 ...
 * Page class
 */
class KemahasiswaanList extends Kemahasiswaan
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "KemahasiswaanList";
    ...
    public string $FormName = "fkemahasiswaanlist";

    // CSS class/style
    public string $CurrentPageName = "kemahasiswaanlist";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        // Initialize URLs
        $this->AddUrl = "kemahasiswaanadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "kemahasiswaandelete";
        $this->MultiUpdateUrl = "kemahasiswaanupdate";
...
// Is modal
        ...
        if ($this->IsModal) {
            $this->FormName = "fkemahasiswaangrid";
        }
		...
		if (ReadCookie('kemahasiswaan_searchpanel') == 'notactive' || ReadCookie('kemahasiswaan_searchpanel') == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (ReadCookie('kemahasiswaan_searchpanel') == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fkemahasiswaansrch");
        }
        $filterList = Concat($filterList, $this->id_kemahasiswaan->AdvancedSearch->toJson(), ","); // Field id_kemahasiswaan
        $filterList = Concat($filterList, $this->NIM->AdvancedSearch->toJson(), ","); // Field NIM
        $filterList = Concat($filterList, $this->Jenis_Beasiswa->AdvancedSearch->toJson(), ","); // Field Jenis_Beasiswa
        $filterList = Concat($filterList, $this->Sumber_beasiswa->AdvancedSearch->toJson(), ","); // Field Sumber_beasiswa
        $filterList = Concat($filterList, $this->Nama_Kegiatan->AdvancedSearch->toJson(), ","); // Field Nama_Kegiatan
        $filterList = Concat($filterList, $this->Nama_Penghargaan_YangDiterima->AdvancedSearch->toJson(), ","); // Field Nama_Penghargaan_Yang Diterima
    ...
    protected function processFilterList(): bool
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fkemahasiswaansrch", $filters);
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field id_kemahasiswaan
        $this->id_kemahasiswaan->AdvancedSearch->SearchValue = $filter["x_id_kemahasiswaan"] ?? "";
        $this->id_kemahasiswaan->AdvancedSearch->SearchOperator = $filter["z_id_kemahasiswaan"] ?? "";
        $this->id_kemahasiswaan->AdvancedSearch->SearchCondition = $filter["v_id_kemahasiswaan"] ?? "";
        $this->id_kemahasiswaan->AdvancedSearch->SearchValue2 = $filter["y_id_kemahasiswaan"] ?? "";
        $this->id_kemahasiswaan->AdvancedSearch->SearchOperator2 = $filter["w_id_kemahasiswaan"] ?? "";
        $this->id_kemahasiswaan->AdvancedSearch->save();
        ...
        // Field Jenis_Beasiswa
        $this->Jenis_Beasiswa->AdvancedSearch->SearchValue = $filter["x_Jenis_Beasiswa"] ?? "";
        $this->Jenis_Beasiswa->AdvancedSearch->SearchOperator = $filter["z_Jenis_Beasiswa"] ?? "";
        $this->Jenis_Beasiswa->AdvancedSearch->SearchCondition = $filter["v_Jenis_Beasiswa"] ?? "";
        $this->Jenis_Beasiswa->AdvancedSearch->SearchValue2 = $filter["y_Jenis_Beasiswa"] ?? "";
        $this->Jenis_Beasiswa->AdvancedSearch->SearchOperator2 = $filter["w_Jenis_Beasiswa"] ?? "";
        $this->Jenis_Beasiswa->AdvancedSearch->save();

        // Field Sumber_beasiswa
        $this->Sumber_beasiswa->AdvancedSearch->SearchValue = $filter["x_Sumber_beasiswa"] ?? "";
        $this->Sumber_beasiswa->AdvancedSearch->SearchOperator = $filter["z_Sumber_beasiswa"] ?? "";
        $this->Sumber_beasiswa->AdvancedSearch->SearchCondition = $filter["v_Sumber_beasiswa"] ?? "";
        $this->Sumber_beasiswa->AdvancedSearch->SearchValue2 = $filter["y_Sumber_beasiswa"] ?? "";
        $this->Sumber_beasiswa->AdvancedSearch->SearchOperator2 = $filter["w_Sumber_beasiswa"] ?? "";
        $this->Sumber_beasiswa->AdvancedSearch->save();
        ...
        // Field Nama_Penghargaan_Yang Diterima
        $this->Nama_Penghargaan_YangDiterima->AdvancedSearch->SearchValue = $filter["x_Nama_Penghargaan_YangDiterima"] ?? "";
        $this->Nama_Penghargaan_YangDiterima->AdvancedSearch->SearchOperator = $filter["z_Nama_Penghargaan_YangDiterima"] ?? "";
        $this->Nama_Penghargaan_YangDiterima->AdvancedSearch->SearchCondition = $filter["v_Nama_Penghargaan_YangDiterima"] ?? "";
        $this->Nama_Penghargaan_YangDiterima->AdvancedSearch->SearchValue2 = $filter["y_Nama_Penghargaan_YangDiterima"] ?? "";
        $this->Nama_Penghargaan_YangDiterima->AdvancedSearch->SearchOperator2 = $filter["w_Nama_Penghargaan_YangDiterima"] ?? "";
        $this->Nama_Penghargaan_YangDiterima->AdvancedSearch->save();
    ...
    public function basicSearchWhere(bool $default = false): string
    {
        ...
        $searchFlds = [];
        $searchFlds[] = &$this->NIM;
        $searchFlds[] = &$this->Jenis_Beasiswa;
        $searchFlds[] = &$this->Sumber_beasiswa;
        $searchFlds[] = &$this->Nama_Kegiatan;
        $searchFlds[] = &$this->Nama_Penghargaan_YangDiterima;
        $searchFlds[] = &$this->Sertifikat;
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->id_kemahasiswaan); // id_kemahasiswaan
            $this->updateSort($this->NIM); // NIM
            $this->updateSort($this->Jenis_Beasiswa); // Jenis_Beasiswa
            $this->updateSort($this->Sumber_beasiswa); // Sumber_beasiswa
            $this->updateSort($this->Nama_Kegiatan); // Nama_Kegiatan
            $this->updateSort($this->Nama_Penghargaan_YangDiterima); // Nama_Penghargaan_Yang Diterima
    ...
    protected function resetCmd(): void
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id_kemahasiswaan->setSort("");
                $this->NIM->setSort("");
                $this->Jenis_Beasiswa->setSort("");
                $this->Sumber_beasiswa->setSort("");
                $this->Nama_Kegiatan->setSort("");
                $this->Nama_Penghargaan_YangDiterima->setSort("");
    ...
    public function renderListOptions(): void
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($this->security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"kemahasiswaan\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $this->language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($this->security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"kemahasiswaan\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-ask=\"1\" data-btn=\"SaveBtn\">" . $this->language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($this->security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
					$opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"kemahasiswaan\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("CopyLink") . "</a>";
                } else {
            ...
            foreach ($this->ListActions as $listAction) { // ActionType::SINGLE
                ...
                if ($listAction->Select == ActionType::SINGLE && $listAction->getVisible()) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                        "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fkemahasiswaanlist\" data-key=\"" . $this->keyToJson(true) .
                    ...
                    if ($body == "") { // Setup first button
                        $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action" . ($listAction->getEnabled() ? "" : " disabled") .
                            "\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fkemahasiswaanlist\" data-key=\"" . $this->keyToJson(true) .
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->id_kemahasiswaan->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions(): void
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
			$item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"kemahasiswaan\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-ask=\"1\" data-btn=\"AddBtn\">" . $this->language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "id_kemahasiswaan");
            $this->createColumnOption($option, "NIM");
            $this->createColumnOption($option, "Jenis_Beasiswa");
            $this->createColumnOption($option, "Sumber_beasiswa");
            $this->createColumnOption($option, "Nama_Kegiatan");
            $this->createColumnOption($option, "Nama_Penghargaan_Yang Diterima");
            $this->createColumnOption($option, "Sertifikat");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fkemahasiswaansrch\" data-ew-action=\"none\">" . $this->language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkemahasiswaansrch\" data-ew-action=\"none\">" . $this->language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions(): void
    {
        ...
        foreach ($this->ListActions as $listAction) { // ActionType::MULTIPLE
            if ($listAction->Select == ActionType::MULTIPLE && $listAction->getVisible()) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fkemahasiswaanlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
                $item->Visible = true;
            }
        }
    ...
    public function setupRow(): void
    {
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_kemahasiswaan", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_kemahasiswaan",
...
// Load basic search values
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (ReadCookie('kemahasiswaan_searchpanel') == 'notactive' || ReadCookie('kemahasiswaan_searchpanel') == "") {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkemahasiswaansrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		} elseif (ReadCookie('kemahasiswaan_searchpanel') == 'active') {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle active\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkemahasiswaansrch\" aria-pressed=\"true\">" . $this->language->phrase("SearchLink") . "</a>";
		} else {
			$item->Body = "<a class=\"btn btn-default ew-search-toggle\" role=\"button\" title=\"" . $this->language->phrase("SearchPanel") . "\" data-caption=\"" . $this->language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fkemahasiswaansrch\" aria-pressed=\"false\">" . $this->language->phrase("SearchLink") . "</a>";
		}
        $item->Visible = true;
