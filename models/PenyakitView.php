 ...
 * Page class
 */
class PenyakitView extends Penyakit
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PenyakitView";
    ...
    // CSS class/style
    public string $CurrentPageName = "penyakitview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_penyakit") ?? Route("id_penyakit")) !== null) {
            $this->RecKey["id_penyakit"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_penyakit") ?? Route("id_penyakit")) !== null) {
            ...
            $this->RecKey["id_penyakit"] = $this->id_penyakit->QueryStringValue;
        } elseif (Post("id_penyakit") !== null) {
            $this->id_penyakit->setFormValue(Post("id_penyakit"));
            $this->RecKey["id_penyakit"] = $this->id_penyakit->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_penyakit->setQueryStringValue($keyValue);
            $this->RecKey["id_penyakit"] = $this->id_penyakit->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "penyakitlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("penyakitlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_penyakit->CurrentValue, $this->CurrentRow['id_penyakit'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "penyakitlist"; // No matching record, return to list
                    } else {
