 ...
 * Page class
 */
class KaryaIlmiahView extends KaryaIlmiah
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KaryaIlmiahView";
    ...
    // CSS class/style
    public string $CurrentPageName = "karyailmiahview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("Id_karya_ilmiah") ?? Route("Id_karya_ilmiah")) !== null) {
            $this->RecKey["Id_karya_ilmiah"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("Id_karya_ilmiah") ?? Route("Id_karya_ilmiah")) !== null) {
            ...
            $this->RecKey["Id_karya_ilmiah"] = $this->Id_karya_ilmiah->QueryStringValue;
        } elseif (Post("Id_karya_ilmiah") !== null) {
            $this->Id_karya_ilmiah->setFormValue(Post("Id_karya_ilmiah"));
            $this->RecKey["Id_karya_ilmiah"] = $this->Id_karya_ilmiah->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Id_karya_ilmiah->setQueryStringValue($keyValue);
            $this->RecKey["Id_karya_ilmiah"] = $this->Id_karya_ilmiah->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "karyailmiahlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("karyailmiahlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Id_karya_ilmiah->CurrentValue, $this->CurrentRow['Id_karya_ilmiah'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "karyailmiahlist"; // No matching record, return to list
                    } else {
