...
/**
 * Table class for cuti_akademik
 */
class CutiAkademik extends DbTable implements LookupTableInterface
{
    ...
    // Fields
    public DbField $id_ca;
    public DbField $NIM;
    public DbField $Pengajuan_Surat_Cuti_Akademik;
    public DbField $Persetujuan_Cuti_Akademik;
    public DbField $Surat_Keterangan_Aktif_Kembali;
    public DbField $Tanggal;
    public DbField $id_user;
    public DbField $user;
    public DbField $ip;
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "cuti_akademik"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_ca
        $this->id_ca = new DbField(
            $this, // Table
            'x_id_ca', // Variable name
            'id_ca', // Name
            '`id_ca`', // Expression
            '`id_ca`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`id_ca`', // Virtual expression
            false, // Is virtual
        ...
        $this->id_ca->InputTextType = "text";
        $this->id_ca->Raw = true;
        $this->id_ca->IsAutoIncrement = true; // Autoincrement field
        $this->id_ca->IsPrimaryKey = true; // Primary key field
        $this->id_ca->Nullable = false; // NOT NULL field
        $this->id_ca->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->id_ca->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['id_ca'] = &$this->id_ca;
        ...
        $this->Pengajuan_Surat_Cuti_Akademik = new DbField(
            $this, // Table
            'x_Pengajuan_Surat_Cuti_Akademik', // Variable name
            'Pengajuan_Surat_Cuti_Akademik', // Name
            '`Pengajuan_Surat_Cuti_Akademik`', // Expression
            '`Pengajuan_Surat_Cuti_Akademik`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Pengajuan_Surat_Cuti_Akademik`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Pengajuan_Surat_Cuti_Akademik->InputTextType = "text";
        $this->Pengajuan_Surat_Cuti_Akademik->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Pengajuan_Surat_Cuti_Akademik'] = &$this->Pengajuan_Surat_Cuti_Akademik;

        // Persetujuan_Cuti_Akademik
        $this->Persetujuan_Cuti_Akademik = new DbField(
            $this, // Table
            'x_Persetujuan_Cuti_Akademik', // Variable name
            'Persetujuan_Cuti_Akademik', // Name
            '`Persetujuan_Cuti_Akademik`', // Expression
            '`Persetujuan_Cuti_Akademik`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Persetujuan_Cuti_Akademik`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Persetujuan_Cuti_Akademik->InputTextType = "text";
        $this->Persetujuan_Cuti_Akademik->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Persetujuan_Cuti_Akademik'] = &$this->Persetujuan_Cuti_Akademik;

        // Surat_Keterangan_Aktif_Kembali
        $this->Surat_Keterangan_Aktif_Kembali = new DbField(
            $this, // Table
            'x_Surat_Keterangan_Aktif_Kembali', // Variable name
            'Surat_Keterangan_Aktif_Kembali', // Name
            '`Surat_Keterangan_Aktif_Kembali`', // Expression
            '`Surat_Keterangan_Aktif_Kembali`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Surat_Keterangan_Aktif_Kembali`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->Surat_Keterangan_Aktif_Kembali->InputTextType = "text";
        $this->Surat_Keterangan_Aktif_Kembali->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['Surat_Keterangan_Aktif_Kembali'] = &$this->Surat_Keterangan_Aktif_Kembali;
        ...
        // id_user
        $this->id_user = new DbField(
            $this, // Table
            'x_id_user', // Variable name
            'id_user', // Name
            '`id_user`', // Expression
            '`id_user`', // Basic search expression
            200, // Type
            30, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`id_user`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->id_user->addMethod("getAutoUpdateValue", fn() => CurrentUserID());
        $this->id_user->InputTextType = "text";
        $this->id_user->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cuti_akademik";
    }
    ...
    public function insert(array &$row): int|bool
    {
        ...
        if ($result) {
            $this->id_ca->setDbValue($conn->lastInsertId());
            $row['id_ca'] = $this->id_ca->DbValue;
        }
        return $result;
    }
    ...
    public function update(array $row, string|array $where = "", ?array $old = null, bool $currentFilter = true): int|bool
    {
        ...
        if ($success) {
            if (!isset($row['id_ca']) && !IsEmpty($this->id_ca->CurrentValue)) {
                $row['id_ca'] = $this->id_ca->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(?array $row, string|array $where = ""): QueryBuilder
    {
        ...
        $where = is_array($where) ? $this->arrayToFilter($where) : $where;
        if ($row) {
            if (array_key_exists('id_ca', $row)) {
                AddFilter($where, QuotedName('id_ca', $this->Dbid) . '=' . QuotedValue($row['id_ca'], $this->id_ca->DataType, $this->Dbid));
            }
        }
    ...
    protected function loadDbValues(?array $row)
    {
        ...
        $this->id_ca->DbValue = $row['id_ca'];
        $this->NIM->DbValue = $row['NIM'];
        $this->Pengajuan_Surat_Cuti_Akademik->DbValue = $row['Pengajuan_Surat_Cuti_Akademik'];
        $this->Persetujuan_Cuti_Akademik->DbValue = $row['Persetujuan_Cuti_Akademik'];
        $this->Surat_Keterangan_Aktif_Kembali->DbValue = $row['Surat_Keterangan_Aktif_Kembali'];
    ...
    {
        $keys = [];
        $val = $current ? $this->id_ca->CurrentValue : $this->id_ca->OldValue;
        if (IsEmpty($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey(string $key, bool $current = false, ?string $keySeparator = null): void
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->id_ca->CurrentValue = $keys[0];
            } else {
                $this->id_ca->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter(?array $row = null, bool $current = false): string
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('id_ca', $row) ? $row['id_ca'] : null;
        } else {
            $val = !IsEmpty($this->id_ca->OldValue) && !$current ? $this->id_ca->OldValue : $this->id_ca->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@id_ca@", AdjustSql($val), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("cutiakademiklist");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "cutiakademikview" => $this->language->phrase("View"),
            "cutiakademikedit" => $this->language->phrase("Edit"),
            "cutiakademikadd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CutiAkademikView",
            Config("API_ADD_ACTION") => "CutiAkademikAdd",
            Config("API_EDIT_ACTION") => "CutiAkademikEdit",
            Config("API_DELETE_ACTION") => "CutiAkademikDelete",
            Config("API_LIST_ACTION") => "CutiAkademikList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("cutiakademikview", $parm);
        } else {
            $url = $this->keyUrl("cutiakademikview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cutiakademikedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cutiakademiklist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cutiakademikadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cutiakademiklist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("cutiakademikdelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"id_ca\":" . VarToJson($this->id_ca->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->id_ca->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->id_ca->CurrentValue);
        } else {
    ...
    public function getRecordKeys(): array
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("id_ca") ?? Route("id_ca")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys(bool $setCurrent = true): string
    {
        ...
        foreach ($arKeys as $key) {
            if ($setCurrent) {
                $this->id_ca->CurrentValue = $key;
            } else {
                $this->id_ca->OldValue = $key;
            }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->id_ca);
                    $doc->exportCaption($this->NIM);
                    $doc->exportCaption($this->Pengajuan_Surat_Cuti_Akademik);
                    $doc->exportCaption($this->Persetujuan_Cuti_Akademik);
                    $doc->exportCaption($this->Surat_Keterangan_Aktif_Kembali);
        ...
        while (($row = $result->fetchAssociative()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->id_ca);
                        $doc->exportField($this->NIM);
                        $doc->exportField($this->Pengajuan_Surat_Cuti_Akademik);
                        $doc->exportField($this->Persetujuan_Cuti_Akademik);
                        $doc->exportField($this->Surat_Keterangan_Aktif_Kembali);
