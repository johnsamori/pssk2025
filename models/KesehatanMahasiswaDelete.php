 ...
 * Page class
 */
class KesehatanMahasiswaDelete extends KesehatanMahasiswa
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KesehatanMahasiswaDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "kesehatanmahasiswadelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("kesehatanmahasiswalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("kesehatanmahasiswalist"); // Return to list
                return;
            }
        }
