 ...
 * Page class
 */
class DaftarMatakuliahAdd extends DaftarMatakuliah
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "DaftarMatakuliahAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "daftarmatakuliahadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "daftarmatakuliahview") {
...
// Get upload files
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->Kode->CurrentValue != "") { // Check field with unique index
            $filter = "(`Kode` = '" . AdjustSql($this->Kode->CurrentValue) . "')";
        ...
        if ($insertRow && $this->ValidateKey && strval($newRow['Kode']) == "") {
    ...
    protected function getAddRow(): array
    {
        ...
        // Kode
        $this->Kode->setDbValueDef($newRow, $this->Kode->CurrentValue, false);

        // Nama
        $this->Nama->setDbValueDef($newRow, $this->Nama->CurrentValue, false);

        // SKS
        $this->SKS->setDbValueDef($newRow, $this->SKS->CurrentValue, false);
        return $newRow;
    }
