 ...
 * Page class
 */
class PembimbinganDelete extends Pembimbingan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PembimbinganDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "pembimbingandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("pembimbinganlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("pembimbinganlist"); // Return to list
                return;
            }
        }
