 ...
 * Page class
 */
class DaftarMatakuliahDelete extends DaftarMatakuliah
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DaftarMatakuliahDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "daftarmatakuliahdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("daftarmatakuliahlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("daftarmatakuliahlist"); // Return to list
                return;
            }
        }
