 ...
 * Page class
 */
class DetilUjianTahapBersamaEdit extends DetilUjianTahapBersama
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "DetilUjianTahapBersamaEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "detilujiantahapbersamaedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("detilujiantahapbersamalist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "detilujiantahapbersamalist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "detilujiantahapbersamalist") {
                            ...
                            $returnUrl = "detilujiantahapbersamalist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
...
// Get upload files
    ...
    protected function setupBreadcrumb(): void
    {
        ...
        $url = CurrentUrl();
        $breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("detilujiantahapbersamalist"), "", $this->TableVar, true);
        $pageId = "edit";
